...
mod cellarwithmultiassetdepositv1_mod {
    ...
    impl<'a, M: ethers::providers::Middleware> CellarWithMultiAssetDepositV1<M> {
        ...
        #[doc = "Gets the contract's `MultiAssetDeposit` event"]
        pub fn multi_asset_deposit_filter(
            &self,
        ) -> ethers::contract::builders::Event<M, MultiAssetDepositFilter> {
            self.0.event()
        }
    ...
    impl ::std::fmt::Display for CellarWithMultiAssetDepositV1Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                CellarWithMultiAssetDepositV1Events::MultiAssetDepositFilter(element) => {
                    element.fmt(f)
                }
