pub use auraerc4626adaptorv1_mod::*;
#[allow(clippy::too_many_arguments)]
mod auraerc4626adaptorv1_mod {
    ...
    #[doc = "AuraERC4626AdaptorV1 was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static AURAERC4626ADAPTORV1_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    impl<M> std::ops::Deref for AuraERC4626AdaptorV1<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for AuraERC4626AdaptorV1<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(AuraERC4626AdaptorV1))
                .field(&self.address())
                .finish()
        }
    }
    impl<'a, M: ethers::providers::Middleware> AuraERC4626AdaptorV1<M> {
    ...
    impl ethers::core::abi::AbiDecode for AuraERC4626AdaptorV1Calls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            ...
            {
                return Ok(AuraERC4626AdaptorV1Calls::AssetOf(decoded));
            }
            if let Ok(decoded) =
                <AssetsUsedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::AssetsUsed(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::BalanceOf(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DepositToVaultCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::DepositToVault(decoded));
            }
            if let Ok(decoded) =
                <GetRewardsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::GetRewards(decoded));
            }
            if let Ok(decoded) =
                <IdentifierCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::Identifier(decoded));
            }
            if let Ok(decoded) = <IsDebtCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::IsDebt(decoded));
            }
            if let Ok(decoded) =
                <RevokeApprovalCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::RevokeApproval(decoded));
            }
            if let Ok(decoded) =
                <SlippageCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::Slippage(decoded));
            }
            if let Ok(decoded) =
                <WithdrawCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::Withdraw(decoded));
            }
            if let Ok(decoded) =
                <WithdrawFromVaultCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::WithdrawFromVault(decoded));
            }
            if let Ok(decoded) =
                <WithdrawableFromCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraERC4626AdaptorV1Calls::WithdrawableFrom(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for AuraERC4626AdaptorV1Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                AuraERC4626AdaptorV1Calls::AssetOf(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::AssetsUsed(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::BalanceOf(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::Deposit(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::DepositToVault(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::GetRewards(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::Identifier(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::IsDebt(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::RevokeApproval(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::Slippage(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::Withdraw(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::WithdrawFromVault(element) => element.encode(),
                AuraERC4626AdaptorV1Calls::WithdrawableFrom(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for AuraERC4626AdaptorV1Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                AuraERC4626AdaptorV1Calls::AssetOf(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::AssetsUsed(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::BalanceOf(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::Deposit(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::DepositToVault(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::GetRewards(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::Identifier(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::IsDebt(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::RevokeApproval(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::Slippage(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::Withdraw(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::WithdrawFromVault(element) => element.fmt(f),
                AuraERC4626AdaptorV1Calls::WithdrawableFrom(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetOfCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: AssetOfCall) -> Self {
            AuraERC4626AdaptorV1Calls::AssetOf(var)
        }
    }
    impl ::std::convert::From<AssetsUsedCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: AssetsUsedCall) -> Self {
            AuraERC4626AdaptorV1Calls::AssetsUsed(var)
        }
    }
    impl ::std::convert::From<BalanceOfCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: BalanceOfCall) -> Self {
            AuraERC4626AdaptorV1Calls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<DepositCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: DepositCall) -> Self {
            AuraERC4626AdaptorV1Calls::Deposit(var)
        }
    }
    impl ::std::convert::From<DepositToVaultCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: DepositToVaultCall) -> Self {
            AuraERC4626AdaptorV1Calls::DepositToVault(var)
        }
    }
    impl ::std::convert::From<GetRewardsCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: GetRewardsCall) -> Self {
            AuraERC4626AdaptorV1Calls::GetRewards(var)
        }
    }
    impl ::std::convert::From<IdentifierCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: IdentifierCall) -> Self {
            AuraERC4626AdaptorV1Calls::Identifier(var)
        }
    }
    impl ::std::convert::From<IsDebtCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: IsDebtCall) -> Self {
            AuraERC4626AdaptorV1Calls::IsDebt(var)
        }
    }
    impl ::std::convert::From<RevokeApprovalCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: RevokeApprovalCall) -> Self {
            AuraERC4626AdaptorV1Calls::RevokeApproval(var)
        }
    }
    impl ::std::convert::From<SlippageCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: SlippageCall) -> Self {
            AuraERC4626AdaptorV1Calls::Slippage(var)
        }
    }
    impl ::std::convert::From<WithdrawCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: WithdrawCall) -> Self {
            AuraERC4626AdaptorV1Calls::Withdraw(var)
        }
    }
    impl ::std::convert::From<WithdrawFromVaultCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: WithdrawFromVaultCall) -> Self {
            AuraERC4626AdaptorV1Calls::WithdrawFromVault(var)
        }
    }
    impl ::std::convert::From<WithdrawableFromCall> for AuraERC4626AdaptorV1Calls {
        fn from(var: WithdrawableFromCall) -> Self {
            AuraERC4626AdaptorV1Calls::WithdrawableFrom(var)
        }
    }
}
