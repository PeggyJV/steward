pub use auraadaptorv1_mod::*;
#[allow(clippy::too_many_arguments)]
mod auraadaptorv1_mod {
    ...
    #[doc = "AuraAdaptorV1 was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static AURAADAPTORV1_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    #[derive(Clone)]
    pub struct AuraAdaptorV1<M>(ethers::contract::Contract<M>);
    impl<M> std::ops::Deref for AuraAdaptorV1<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for AuraAdaptorV1<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(AuraAdaptorV1))
                .field(&self.address())
                .finish()
        }
    }
    impl<'a, M: ethers::providers::Middleware> AuraAdaptorV1<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            let contract =
                ethers::contract::Contract::new(address.into(), AURAADAPTORV1_ABI.clone(), client);
            Self(contract)
        }
    ...
    impl ethers::core::abi::AbiDecode for AuraAdaptorV1Calls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
                <AssetOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::AssetOf(decoded));
            }
            if let Ok(decoded) =
                <AssetsUsedCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::AssetsUsed(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::BalanceOf(decoded));
            }
            if let Ok(decoded) =
                <DepositCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::Deposit(decoded));
            }
            if let Ok(decoded) =
                <DepositToVaultCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::DepositToVault(decoded));
            }
            if let Ok(decoded) =
                <GetRewardsCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::GetRewards(decoded));
            }
            if let Ok(decoded) =
                <IdentifierCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::Identifier(decoded));
            }
            if let Ok(decoded) = <IsDebtCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::IsDebt(decoded));
            }
            if let Ok(decoded) =
                <RevokeApprovalCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::RevokeApproval(decoded));
            }
            if let Ok(decoded) =
                <SlippageCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::Slippage(decoded));
            }
            if let Ok(decoded) =
                <WithdrawCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::Withdraw(decoded));
            }
            if let Ok(decoded) =
                <WithdrawFromVaultCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::WithdrawFromVault(decoded));
            }
            if let Ok(decoded) =
                <WithdrawableFromCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AuraAdaptorV1Calls::WithdrawableFrom(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for AuraAdaptorV1Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                AuraAdaptorV1Calls::AssetOf(element) => element.encode(),
                AuraAdaptorV1Calls::AssetsUsed(element) => element.encode(),
                AuraAdaptorV1Calls::BalanceOf(element) => element.encode(),
                AuraAdaptorV1Calls::Deposit(element) => element.encode(),
                AuraAdaptorV1Calls::DepositToVault(element) => element.encode(),
                AuraAdaptorV1Calls::GetRewards(element) => element.encode(),
                AuraAdaptorV1Calls::Identifier(element) => element.encode(),
                AuraAdaptorV1Calls::IsDebt(element) => element.encode(),
                AuraAdaptorV1Calls::RevokeApproval(element) => element.encode(),
                AuraAdaptorV1Calls::Slippage(element) => element.encode(),
                AuraAdaptorV1Calls::Withdraw(element) => element.encode(),
                AuraAdaptorV1Calls::WithdrawFromVault(element) => element.encode(),
                AuraAdaptorV1Calls::WithdrawableFrom(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for AuraAdaptorV1Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                AuraAdaptorV1Calls::AssetOf(element) => element.fmt(f),
                AuraAdaptorV1Calls::AssetsUsed(element) => element.fmt(f),
                AuraAdaptorV1Calls::BalanceOf(element) => element.fmt(f),
                AuraAdaptorV1Calls::Deposit(element) => element.fmt(f),
                AuraAdaptorV1Calls::DepositToVault(element) => element.fmt(f),
                AuraAdaptorV1Calls::GetRewards(element) => element.fmt(f),
                AuraAdaptorV1Calls::Identifier(element) => element.fmt(f),
                AuraAdaptorV1Calls::IsDebt(element) => element.fmt(f),
                AuraAdaptorV1Calls::RevokeApproval(element) => element.fmt(f),
                AuraAdaptorV1Calls::Slippage(element) => element.fmt(f),
                AuraAdaptorV1Calls::Withdraw(element) => element.fmt(f),
                AuraAdaptorV1Calls::WithdrawFromVault(element) => element.fmt(f),
                AuraAdaptorV1Calls::WithdrawableFrom(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AssetOfCall> for AuraAdaptorV1Calls {
        fn from(var: AssetOfCall) -> Self {
            AuraAdaptorV1Calls::AssetOf(var)
        }
    }
    impl ::std::convert::From<AssetsUsedCall> for AuraAdaptorV1Calls {
        fn from(var: AssetsUsedCall) -> Self {
            AuraAdaptorV1Calls::AssetsUsed(var)
        }
    }
    impl ::std::convert::From<BalanceOfCall> for AuraAdaptorV1Calls {
        fn from(var: BalanceOfCall) -> Self {
            AuraAdaptorV1Calls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<DepositCall> for AuraAdaptorV1Calls {
        fn from(var: DepositCall) -> Self {
            AuraAdaptorV1Calls::Deposit(var)
        }
    }
    impl ::std::convert::From<DepositToVaultCall> for AuraAdaptorV1Calls {
        fn from(var: DepositToVaultCall) -> Self {
            AuraAdaptorV1Calls::DepositToVault(var)
        }
    }
    impl ::std::convert::From<GetRewardsCall> for AuraAdaptorV1Calls {
        fn from(var: GetRewardsCall) -> Self {
            AuraAdaptorV1Calls::GetRewards(var)
        }
    }
    impl ::std::convert::From<IdentifierCall> for AuraAdaptorV1Calls {
        fn from(var: IdentifierCall) -> Self {
            AuraAdaptorV1Calls::Identifier(var)
        }
    }
    impl ::std::convert::From<IsDebtCall> for AuraAdaptorV1Calls {
        fn from(var: IsDebtCall) -> Self {
            AuraAdaptorV1Calls::IsDebt(var)
        }
    }
    impl ::std::convert::From<RevokeApprovalCall> for AuraAdaptorV1Calls {
        fn from(var: RevokeApprovalCall) -> Self {
            AuraAdaptorV1Calls::RevokeApproval(var)
        }
    }
    impl ::std::convert::From<SlippageCall> for AuraAdaptorV1Calls {
        fn from(var: SlippageCall) -> Self {
            AuraAdaptorV1Calls::Slippage(var)
        }
    }
    impl ::std::convert::From<WithdrawCall> for AuraAdaptorV1Calls {
        fn from(var: WithdrawCall) -> Self {
            AuraAdaptorV1Calls::Withdraw(var)
        }
    }
    impl ::std::convert::From<WithdrawFromVaultCall> for AuraAdaptorV1Calls {
        fn from(var: WithdrawFromVaultCall) -> Self {
            AuraAdaptorV1Calls::WithdrawFromVault(var)
        }
    }
    impl ::std::convert::From<WithdrawableFromCall> for AuraAdaptorV1Calls {
        fn from(var: WithdrawableFromCall) -> Self {
            AuraAdaptorV1Calls::WithdrawableFrom(var)
        }
    }
}
