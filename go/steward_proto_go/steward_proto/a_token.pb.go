...
func (*AaveATokenAdaptorV1Calls) Descriptor() ([]byte, []int) {
	return file_a_token_proto_rawDescGZIP(), []int{2}
}
...
func (*AaveATokenAdaptorV2Calls) Descriptor() ([]byte, []int) {
	return file_a_token_proto_rawDescGZIP(), []int{3}
}
...
func (x *AaveATokenAdaptorV1_DepositToAave) Reset() {
	*x = AaveATokenAdaptorV1_DepositToAave{}
	if protoimpl.UnsafeEnabled {
		mi := &file_a_token_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AaveATokenAdaptorV1_WithdrawFromAave) Reset() {
	*x = AaveATokenAdaptorV1_WithdrawFromAave{}
	if protoimpl.UnsafeEnabled {
		mi := &file_a_token_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *AaveATokenAdaptorV2_DepositToAave) Reset() {
	*x = AaveATokenAdaptorV2_DepositToAave{}
	if protoimpl.UnsafeEnabled {
		mi := &file_a_token_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AaveATokenAdaptorV2_DepositToAave) Descriptor() ([]byte, []int) {
	return file_a_token_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *AaveATokenAdaptorV2_WithdrawFromAave) Reset() {
	*x = AaveATokenAdaptorV2_WithdrawFromAave{}
	if protoimpl.UnsafeEnabled {
		mi := &file_a_token_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AaveATokenAdaptorV2_WithdrawFromAave) Descriptor() ([]byte, []int) {
	return file_a_token_proto_rawDescGZIP(), []int{1, 1}
}
...
var file_a_token_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x04, 0x0a, 0x13, 0x41, 0x61, 0x76, 0x65,
	...
	0x6f, 0x73, 0x69, 0x74, 0x5f, 0x74, 0x6f, 0x5f, 0x61, 0x61, 0x76, 0x65, 0x18, 0x04, 0x20, 0x01,
	...
	0x76, 0x65, 0x12, 0x60, 0x0a, 0x12, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x5f, 0x66,
	0x72, 0x6f, 0x6d, 0x5f, 0x61, 0x61, 0x76, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30,
	...
	0x6e, 0x22, 0xa4, 0x03, 0x0a, 0x13, 0x41, 0x61, 0x76, 0x65, 0x41, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x61, 0x76, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x73, 0x74, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x2e, 0x76, 0x34, 0x2e, 0x41, 0x61, 0x76, 0x65, 0x41, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x41, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x56, 0x32, 0x2e, 0x44, 0x65, 0x70, 0x6f, 0x73,
	...
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e,
	0x76, 0x34, 0x2e, 0x41, 0x61, 0x76, 0x65, 0x41, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x61,
	0x70, 0x74, 0x6f, 0x72, 0x56, 0x32, 0x2e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x46,
	...
	0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x51, 0x0a, 0x18, 0x41, 0x61, 0x76, 0x65,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x34,
	0x2e, 0x41, 0x61, 0x76, 0x65, 0x41, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x61, 0x70, 0x74,
	0x6f, 0x72, 0x56, 0x31, 0x52, 0x05, 0x63, 0x61, 0x6c, 0x6c, 0x73, 0x22, 0x51, 0x0a, 0x18, 0x41,
	0x61, 0x76, 0x65, 0x41, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72,
	0x56, 0x32, 0x43, 0x61, 0x6c, 0x6c, 0x73, 0x12, 0x35, 0x0a, 0x05, 0x63, 0x61, 0x6c, 0x6c, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64,
...
var file_a_token_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
func file_a_token_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_a_token_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_a_token_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_a_token_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_a_token_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_a_token_proto_msgTypes[1].OneofWrappers = []interface{}{
