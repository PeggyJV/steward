...
type UniswapV3Adaptor_OpenPosition_ struct {
	...
	OpenPosition *UniswapV3Adaptor_OpenPosition `protobuf:"bytes,1,opt,name=open_position,json=openPosition,proto3,oneof"`
}
...
type UniswapV3Adaptor_ClosePosition_ struct {
	...
	ClosePosition *UniswapV3Adaptor_ClosePosition `protobuf:"bytes,2,opt,name=close_position,json=closePosition,proto3,oneof"`
}
...
type UniswapV3Adaptor_AddToPosition_ struct {
	...
	AddToPosition *UniswapV3Adaptor_AddToPosition `protobuf:"bytes,3,opt,name=add_to_position,json=addToPosition,proto3,oneof"`
}
...
type UniswapV3Adaptor_TakeFromPosition_ struct {
	...
	TakeFromPosition *UniswapV3Adaptor_TakeFromPosition `protobuf:"bytes,4,opt,name=take_from_position,json=takeFromPosition,proto3,oneof"`
}
...
type UniswapV3Adaptor_OpenPosition struct {
	...
	TickLower uint32 `protobuf:"varint,8,opt,name=tick_lower,json=tickLower,proto3" json:"tick_lower,omitempty"`
	TickUpper uint32 `protobuf:"varint,9,opt,name=tick_upper,json=tickUpper,proto3" json:"tick_upper,omitempty"`
}
...
func (x *UniswapV3Adaptor_OpenPosition) GetTickLower() uint32 {
	if x != nil {
		return x.TickLower
	}
	return 0
...
func (x *UniswapV3Adaptor_OpenPosition) GetTickUpper() uint32 {
	if x != nil {
		return x.TickUpper
	}
	return 0
...
var file_adaptors_uniswap_uniswap_v3_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x28, 0x0d, 0x52, 0x09, 0x74, 0x69, 0x63, 0x6b, 0x4c, 0x6f, 0x77, 0x65, 0x72, 0x12, 0x1d, 0x0a,
	0x0a, 0x74, 0x69, 0x63, 0x6b, 0x5f, 0x75, 0x70, 0x70, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x09, 0x74, 0x69, 0x63, 0x6b, 0x55, 0x70, 0x70, 0x65, 0x72, 0x1a, 0x5a, 0x0a, 0x0d,
	0x43, 0x6c, 0x6f, 0x73, 0x65, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a,
	0x0b, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x13,
	...
	0x28, 0x09, 0x52, 0x04, 0x6d, 0x69, 0x6e, 0x31, 0x1a, 0x90, 0x01, 0x0a, 0x0d, 0x41, 0x64, 0x64,
	0x54, 0x6f, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x61,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6d, 0x69, 0x6e, 0x31, 0x1a, 0x9e, 0x01, 0x0a, 0x10,
	...
	,
...
var file_adaptors_uniswap_uniswap_v3_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_adaptors_uniswap_uniswap_v3_proto_depIdxs = []int32{
	2, // 0: steward.v2.UniswapV3Adaptor.open_position:type_name -> steward.v2.UniswapV3Adaptor.OpenPosition
	3, // 1: steward.v2.UniswapV3Adaptor.close_position:type_name -> steward.v2.UniswapV3Adaptor.ClosePosition
	4, // 2: steward.v2.UniswapV3Adaptor.add_to_position:type_name -> steward.v2.UniswapV3Adaptor.AddToPosition
	5, // 3: steward.v2.UniswapV3Adaptor.take_from_position:type_name -> steward.v2.UniswapV3Adaptor.TakeFromPosition
	0, // 4: steward.v2.UniswapV3AdaptorCalls.calls:type_name -> steward.v2.UniswapV3Adaptor
