...
var file_adaptors_aave_a_token_proto_rawDesc = []byte{
	...
	0x33, 0x2e, 0x53, 0x77, 0x61, 0x70, 0x48, 0x00, 0x52, 0x04, 0x73, 0x77, 0x61, 0x70, 0x12, 0x39,
...
var file_adaptors_aave_a_token_proto_goTypes = []interface{}{
	(*AaveATokenAdaptorV1)(nil),                  // 0: steward.v3.AaveATokenAdaptorV1
	(*AaveATokenAdaptorV2)(nil),                  // 1: steward.v3.AaveATokenAdaptorV2
	(*AaveATokenAdaptorV1Calls)(nil),             // 2: steward.v3.AaveATokenAdaptorV1Calls
	(*AaveATokenAdaptorV2Calls)(nil),             // 3: steward.v3.AaveATokenAdaptorV2Calls
	(*AaveATokenAdaptorV1_DepositToAave)(nil),    // 4: steward.v3.AaveATokenAdaptorV1.DepositToAave
	(*AaveATokenAdaptorV1_WithdrawFromAave)(nil), // 5: steward.v3.AaveATokenAdaptorV1.WithdrawFromAave
	(*AaveATokenAdaptorV2_DepositToAave)(nil),    // 6: steward.v3.AaveATokenAdaptorV2.DepositToAave
	(*AaveATokenAdaptorV2_WithdrawFromAave)(nil), // 7: steward.v3.AaveATokenAdaptorV2.WithdrawFromAave
	(*Swap)(nil),           // 8: steward.v3.Swap
	(*OracleSwap)(nil),     // 9: steward.v3.OracleSwap
	(*RevokeApproval)(nil), // 10: steward.v3.RevokeApproval
}
var file_adaptors_aave_a_token_proto_depIdxs = []int32{
	8,  // 0: steward.v3.AaveATokenAdaptorV1.swap:type_name -> steward.v3.Swap
	9,  // 1: steward.v3.AaveATokenAdaptorV1.oracle_swap:type_name -> steward.v3.OracleSwap
	10, // 2: steward.v3.AaveATokenAdaptorV1.revoke_approval:type_name -> steward.v3.RevokeApproval
	4,  // 3: steward.v3.AaveATokenAdaptorV1.deposit_to_aave:type_name -> steward.v3.AaveATokenAdaptorV1.DepositToAave
	5,  // 4: steward.v3.AaveATokenAdaptorV1.withdraw_from_aave:type_name -> steward.v3.AaveATokenAdaptorV1.WithdrawFromAave
	10, // 5: steward.v3.AaveATokenAdaptorV2.revoke_approval:type_name -> steward.v3.RevokeApproval
	6,  // 6: steward.v3.AaveATokenAdaptorV2.deposit_to_aave:type_name -> steward.v3.AaveATokenAdaptorV2.DepositToAave
	7,  // 7: steward.v3.AaveATokenAdaptorV2.withdraw_from_aave:type_name -> steward.v3.AaveATokenAdaptorV2.WithdrawFromAave
	0,  // 8: steward.v3.AaveATokenAdaptorV1Calls.calls:type_name -> steward.v3.AaveATokenAdaptorV1
	1,  // 9: steward.v3.AaveATokenAdaptorV2Calls.calls:type_name -> steward.v3.AaveATokenAdaptorV2
