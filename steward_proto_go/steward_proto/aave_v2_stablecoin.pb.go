...
var file_aave_v2_stablecoin_proto_goTypes = []interface{}{
	...
	(*AaveV2Stablecoin_Accrue)(nil),                  // 1: steward.v3.AaveV2Stablecoin.Accrue
	(*AaveV2Stablecoin_ClaimAndUnstake)(nil),         // 2: steward.v3.AaveV2Stablecoin.ClaimAndUnstake
	(*AaveV2Stablecoin_EnterPosition)(nil),           // 3: steward.v3.AaveV2Stablecoin.EnterPosition
	(*AaveV2Stablecoin_EnterPositionWithAssets)(nil), // 4: steward.v3.AaveV2Stablecoin.EnterPositionWithAssets
	(*AaveV2Stablecoin_ExitPosition)(nil),            // 5: steward.v3.AaveV2Stablecoin.ExitPosition
	(*AaveV2Stablecoin_ExitPositionWithAssets)(nil),  // 6: steward.v3.AaveV2Stablecoin.ExitPositionWithAssets
	(*AaveV2Stablecoin_Rebalance)(nil),               // 7: steward.v3.AaveV2Stablecoin.Rebalance
	(*AaveV2Stablecoin_Reinvest)(nil),                // 8: steward.v3.AaveV2Stablecoin.Reinvest
	(*AaveV2Stablecoin_SetAccrualPeriod)(nil),        // 9: steward.v3.AaveV2Stablecoin.SetAccrualPeriod
	(*AaveV2Stablecoin_SetDepositLimit)(nil),         // 10: steward.v3.AaveV2Stablecoin.SetDepositLimit
	(*AaveV2Stablecoin_SetLiquidityLimit)(nil),       // 11: steward.v3.AaveV2Stablecoin.SetLiquidityLimit
	(*AaveV2Stablecoin_SendFees)(nil),                // 12: steward.v3.AaveV2Stablecoin.SendFees
	(*AaveV2Stablecoin_Rebalance_SwapParams)(nil),    // 13: steward.v3.AaveV2Stablecoin.Rebalance.SwapParams
}
var file_aave_v2_stablecoin_proto_depIdxs = []int32{
	1,  // 0: steward.v3.AaveV2Stablecoin.accrue:type_name -> steward.v3.AaveV2Stablecoin.Accrue
	2,  // 1: steward.v3.AaveV2Stablecoin.claim_and_unstake:type_name -> steward.v3.AaveV2Stablecoin.ClaimAndUnstake
	3,  // 2: steward.v3.AaveV2Stablecoin.enter_position:type_name -> steward.v3.AaveV2Stablecoin.EnterPosition
	4,  // 3: steward.v3.AaveV2Stablecoin.enter_position_with_assets:type_name -> steward.v3.AaveV2Stablecoin.EnterPositionWithAssets
	5,  // 4: steward.v3.AaveV2Stablecoin.exit_position:type_name -> steward.v3.AaveV2Stablecoin.ExitPosition
	6,  // 5: steward.v3.AaveV2Stablecoin.exit_position_with_assets:type_name -> steward.v3.AaveV2Stablecoin.ExitPositionWithAssets
	7,  // 6: steward.v3.AaveV2Stablecoin.rebalance:type_name -> steward.v3.AaveV2Stablecoin.Rebalance
	8,  // 7: steward.v3.AaveV2Stablecoin.reinvest:type_name -> steward.v3.AaveV2Stablecoin.Reinvest
	9,  // 8: steward.v3.AaveV2Stablecoin.set_accrual_period:type_name -> steward.v3.AaveV2Stablecoin.SetAccrualPeriod
	10, // 9: steward.v3.AaveV2Stablecoin.set_deposit_limit:type_name -> steward.v3.AaveV2Stablecoin.SetDepositLimit
	11, // 10: steward.v3.AaveV2Stablecoin.set_liquidity_limit:type_name -> steward.v3.AaveV2Stablecoin.SetLiquidityLimit
	12, // 11: steward.v3.AaveV2Stablecoin.send_fees:type_name -> steward.v3.AaveV2Stablecoin.SendFees
	13, // 12: steward.v3.AaveV2Stablecoin.Rebalance.swap_params:type_name -> steward.v3.AaveV2Stablecoin.Rebalance.SwapParams
