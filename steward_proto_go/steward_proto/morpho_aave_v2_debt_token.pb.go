...
// 	protoc        v3.21.12
// source: adaptors/morpho/morpho_aave_v2_debt_token.proto
...
func (x *MorphoAaveV2DebtTokenAdaptorV1) Reset() {
	*x = MorphoAaveV2DebtTokenAdaptorV1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[0]
...
func (*MorphoAaveV2DebtTokenAdaptorV1) Descriptor() ([]byte, []int) {
	return file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescGZIP(), []int{0}
}
...
func (x *MorphoAaveV2DebtTokenAdaptorV1Calls) Reset() {
	*x = MorphoAaveV2DebtTokenAdaptorV1Calls{}
	if protoimpl.UnsafeEnabled {
		mi := &file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MorphoAaveV2DebtTokenAdaptorV1Calls) Descriptor() ([]byte, []int) {
	return file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescGZIP(), []int{1}
}
...
func (x *MorphoAaveV2DebtTokenAdaptorV1_BorrowFromAaveV2Morpho) Reset() {
	*x = MorphoAaveV2DebtTokenAdaptorV1_BorrowFromAaveV2Morpho{}
	if protoimpl.UnsafeEnabled {
		mi := &file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MorphoAaveV2DebtTokenAdaptorV1_BorrowFromAaveV2Morpho) Descriptor() ([]byte, []int) {
	return file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *MorphoAaveV2DebtTokenAdaptorV1_RepayAaveV2MorphoDebt) Reset() {
	*x = MorphoAaveV2DebtTokenAdaptorV1_RepayAaveV2MorphoDebt{}
	if protoimpl.UnsafeEnabled {
		mi := &file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MorphoAaveV2DebtTokenAdaptorV1_RepayAaveV2MorphoDebt) Descriptor() ([]byte, []int) {
	return file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_adaptors_morpho_morpho_aave_v2_debt_token_proto protoreflect.FileDescriptor

var file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xa9, 0x04, 0x0a, 0x1e, 0x4d, 0x6f, 0x72, 0x70, 0x68, 0x6f, 0x41, 0x61, 0x76,
	...
	0x5f, 0x76, 0x32, 0x5f, 0x6d, 0x6f, 0x72, 0x70, 0x68, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x72, 0x6f, 0x77, 0x46, 0x72, 0x6f, 0x6d, 0x41, 0x61, 0x76, 0x65, 0x56, 0x32, 0x4d, 0x6f, 0x72,
	0x70, 0x68, 0x6f, 0x48, 0x00, 0x52, 0x16, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x46, 0x72, 0x6f,
	0x6d, 0x41, 0x61, 0x76, 0x65, 0x56, 0x32, 0x4d, 0x6f, 0x72, 0x70, 0x68, 0x6f, 0x12, 0x7c, 0x0a,
	0x19, 0x72, 0x65, 0x70, 0x61, 0x79, 0x5f, 0x61, 0x61, 0x76, 0x65, 0x5f, 0x76, 0x32, 0x5f, 0x6d,
	...
	0x32, 0x4d, 0x6f, 0x72, 0x70, 0x68, 0x6f, 0x44, 0x65, 0x62, 0x74, 0x1a, 0x5b, 0x0a, 0x16, 0x42,
	0x6f, 0x72, 0x72, 0x6f, 0x77, 0x46, 0x72, 0x6f, 0x6d, 0x41, 0x61, 0x76, 0x65, 0x56, 0x32, 0x4d,
	0x6f, 0x72, 0x70, 0x68, 0x6f, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x28,
	...
	,
...
var (
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescOnce sync.Once
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescData = file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDesc
)

func file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescGZIP() []byte {
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescOnce.Do(func() {
		file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescData = protoimpl.X.CompressGZIP(file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescData)
	})
	return file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDescData
}

var file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_adaptors_morpho_morpho_aave_v2_debt_token_proto_goTypes = []interface{}{
	(*MorphoAaveV2DebtTokenAdaptorV1)(nil),                        // 0: steward.v3.MorphoAaveV2DebtTokenAdaptorV1
	(*MorphoAaveV2DebtTokenAdaptorV1Calls)(nil),                   // 1: steward.v3.MorphoAaveV2DebtTokenAdaptorV1Calls
	(*MorphoAaveV2DebtTokenAdaptorV1_BorrowFromAaveV2Morpho)(nil), // 2: steward.v3.MorphoAaveV2DebtTokenAdaptorV1.BorrowFromAaveV2Morpho
	(*MorphoAaveV2DebtTokenAdaptorV1_RepayAaveV2MorphoDebt)(nil),  // 3: steward.v3.MorphoAaveV2DebtTokenAdaptorV1.RepayAaveV2MorphoDebt
	(*RevokeApproval)(nil),                                        // 4: steward.v3.RevokeApproval
}
var file_adaptors_morpho_morpho_aave_v2_debt_token_proto_depIdxs = []int32{
	4, // 0: steward.v3.MorphoAaveV2DebtTokenAdaptorV1.revoke_approval:type_name -> steward.v3.RevokeApproval
	2, // 1: steward.v3.MorphoAaveV2DebtTokenAdaptorV1.borrow_from_aave_v2_morpho:type_name -> steward.v3.MorphoAaveV2DebtTokenAdaptorV1.BorrowFromAaveV2Morpho
	3, // 2: steward.v3.MorphoAaveV2DebtTokenAdaptorV1.repay_aave_v2_morpho_debt:type_name -> steward.v3.MorphoAaveV2DebtTokenAdaptorV1.RepayAaveV2MorphoDebt
	0, // 3: steward.v3.MorphoAaveV2DebtTokenAdaptorV1Calls.calls:type_name -> steward.v3.MorphoAaveV2DebtTokenAdaptorV1
...
func init() { file_adaptors_morpho_morpho_aave_v2_debt_token_proto_init() }
func file_adaptors_morpho_morpho_aave_v2_debt_token_proto_init() {
	if File_adaptors_morpho_morpho_aave_v2_debt_token_proto != nil {
		return
	}
	file_adaptors_base_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_adaptors_morpho_morpho_aave_v2_debt_token_proto_goTypes,
		DependencyIndexes: file_adaptors_morpho_morpho_aave_v2_debt_token_proto_depIdxs,
		MessageInfos:      file_adaptors_morpho_morpho_aave_v2_debt_token_proto_msgTypes,
	}.Build()
	File_adaptors_morpho_morpho_aave_v2_debt_token_proto = out.File
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_rawDesc = nil
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_goTypes = nil
	file_adaptors_morpho_morpho_aave_v2_debt_token_proto_depIdxs = nil
}
