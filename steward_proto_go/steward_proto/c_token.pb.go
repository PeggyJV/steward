...
// 	protoc        v3.21.12
// source: steward/v3/c_token.proto
...
func (x *CompoundCTokenAdaptor) Reset() {
	*x = CompoundCTokenAdaptor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[0]
...
func (*CompoundCTokenAdaptor) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{0}
}
...
func (x *CompoundCTokenAdaptorCalls) Reset() {
	*x = CompoundCTokenAdaptorCalls{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompoundCTokenAdaptorCalls) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{1}
}
...
func (x *CompoundCTokenAdaptor_DepositToCompound) Reset() {
	*x = CompoundCTokenAdaptor_DepositToCompound{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompoundCTokenAdaptor_DepositToCompound) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CompoundCTokenAdaptor_WithdrawFromCompound) Reset() {
	*x = CompoundCTokenAdaptor_WithdrawFromCompound{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompoundCTokenAdaptor_WithdrawFromCompound) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *CompoundCTokenAdaptor_ClaimComp) Reset() {
	*x = CompoundCTokenAdaptor_ClaimComp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompoundCTokenAdaptor_ClaimComp) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *CompoundCTokenAdaptor_ClaimCompAndSwap) Reset() {
	*x = CompoundCTokenAdaptor_ClaimCompAndSwap{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steward_v3_c_token_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompoundCTokenAdaptor_ClaimCompAndSwap) Descriptor() ([]byte, []int) {
	return file_steward_v3_c_token_proto_rawDescGZIP(), []int{0, 3}
}
...
var File_steward_v3_c_token_proto protoreflect.FileDescriptor

var file_steward_v3_c_token_proto_rawDesc = []byte{
	0x0a, 0x18, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2f, 0x76, 0x33, 0x2f, 0x63, 0x5f, 0x74,
	...
	,
	...
	0x6b, 0x65, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x12, 0x65, 0x0a, 0x13, 0x64, 0x65,
	...
	0x6f, 0x6d, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x36, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x33, 0x2e, 0x43,
	...
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e,
	...
	0x64, 0x5f, 0x73, 0x77, 0x61, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x73,
...
var (
	file_steward_v3_c_token_proto_rawDescOnce sync.Once
	file_steward_v3_c_token_proto_rawDescData = file_steward_v3_c_token_proto_rawDesc
)

func file_steward_v3_c_token_proto_rawDescGZIP() []byte {
	file_steward_v3_c_token_proto_rawDescOnce.Do(func() {
		file_steward_v3_c_token_proto_rawDescData = protoimpl.X.CompressGZIP(file_steward_v3_c_token_proto_rawDescData)
	})
	return file_steward_v3_c_token_proto_rawDescData
}

var file_steward_v3_c_token_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_steward_v3_c_token_proto_goTypes = []interface{}{
...
var file_steward_v3_c_token_proto_depIdxs = []int32{
...
func init() { file_steward_v3_c_token_proto_init() }
func file_steward_v3_c_token_proto_init() {
	if File_steward_v3_c_token_proto != nil {
		return
	}
	file_steward_v3_base_proto_init()
	file_steward_v3_common_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_steward_v3_c_token_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steward_v3_c_token_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steward_v3_c_token_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steward_v3_c_token_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steward_v3_c_token_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_steward_v3_c_token_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_steward_v3_c_token_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_steward_v3_c_token_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_steward_v3_c_token_proto_goTypes,
		DependencyIndexes: file_steward_v3_c_token_proto_depIdxs,
		MessageInfos:      file_steward_v3_c_token_proto_msgTypes,
	}.Build()
	File_steward_v3_c_token_proto = out.File
	file_steward_v3_c_token_proto_rawDesc = nil
	file_steward_v3_c_token_proto_goTypes = nil
	file_steward_v3_c_token_proto_depIdxs = nil
}
