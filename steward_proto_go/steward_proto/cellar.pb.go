...
func (x *Cellar) GetPopPosition() *PopPosition {
	if x, ok := x.GetFunction().(*Cellar_PopPosition); ok {
		return x.PopPosition
	}
	return nil
}
...
func (x *Cellar) GetReplacePosition() *ReplacePosition {
	if x, ok := x.GetFunction().(*Cellar_ReplacePosition); ok {
		return x.ReplacePosition
	}
	return nil
}
...
type Cellar_PopPosition struct {
	// Represents function `popPosition()`
	PopPosition *PopPosition `protobuf:"bytes,2,opt,name=pop_position,json=popPosition,proto3,oneof"`
}

type Cellar_PushPosition struct {
	// Represents function `pushPosition(address position)`
	PushPosition *PushPosition `protobuf:"bytes,3,opt,name=push_position,json=pushPosition,proto3,oneof"`
}

type Cellar_RemovePosition struct {
	// Represents function `removePosition(uint256 index)`
	RemovePosition *RemovePosition `protobuf:"bytes,4,opt,name=remove_position,json=removePosition,proto3,oneof"`
}

type Cellar_ReplacePosition struct {
	// Represents function `replacePosition(uint256, address newPosition)`
	ReplacePosition *ReplacePosition `protobuf:"bytes,5,opt,name=replace_position,json=replacePosition,proto3,oneof"`
}

type Cellar_SetHoldingPosition struct {
	// Represents function `setHoldingPosition(address newHoldingPosition)`
	SetHoldingPosition *SetHoldingPosition `protobuf:"bytes,6,opt,name=set_holding_position,json=setHoldingPosition,proto3,oneof"`
}
...
type Cellar_Rebalance struct {
	...
	Rebalance *Rebalance `protobuf:"bytes,7,opt,name=rebalance,proto3,oneof"`
}

type Cellar_SetStrategistPayoutAddress struct {
	// Represents function `setStrategistPayoutAddress(address payout)`
	SetStrategistPayoutAddress *SetStrategistPayoutAddress `protobuf:"bytes,8,opt,name=set_strategist_payout_address,json=setStrategistPayoutAddress,proto3,oneof"`
}

type Cellar_SetWithdrawType struct {
	// Represents function `setWithdrawType(WithdrawType newWithdrawType)`
	SetWithdrawType *SetWithdrawType `protobuf:"bytes,9,opt,name=set_withdraw_type,json=setWithdrawType,proto3,oneof"`
}

type Cellar_SwapPositions struct {
	// Represents function `swapPositions(uint256 index1, uint256 index2)`
	SwapPositions *SwapPositions `protobuf:"bytes,10,opt,name=swap_positions,json=swapPositions,proto3,oneof"`
}

func (*Cellar_AddPosition) isCellar_Function() {}

func (*Cellar_PopPosition) isCellar_Function() {}

func (*Cellar_PushPosition) isCellar_Function() {}

func (*Cellar_RemovePosition) isCellar_Function() {}

func (*Cellar_ReplacePosition) isCellar_Function() {}
...
//
// Represents function `popPosition()`
type PopPosition struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PopPosition) Reset() {
	*x = PopPosition{}
	if protoimpl.UnsafeEnabled {
...
func (x *PopPosition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PopPosition) ProtoMessage() {}

func (x *PopPosition) ProtoReflect() protoreflect.Message {
	mi := &file_cellar_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PopPosition.ProtoReflect.Descriptor instead.
func (*PopPosition) Descriptor() ([]byte, []int) {
...
type ReplacePosition struct {
	...
	NewPosition string `protobuf:"bytes,2,opt,name=new_position,json=newPosition,proto3" json:"new_position,omitempty"`
}

func (x *ReplacePosition) Reset() {
	*x = ReplacePosition{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplacePosition) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplacePosition) ProtoMessage() {}

func (x *ReplacePosition) ProtoReflect() protoreflect.Message {
	mi := &file_cellar_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplacePosition.ProtoReflect.Descriptor instead.
func (*ReplacePosition) Descriptor() ([]byte, []int) {
	return file_cellar_proto_rawDescGZIP(), []int{5}
}

func (x *ReplacePosition) GetIndex() uint64 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *ReplacePosition) GetNewPosition() string {
	if x != nil {
...
var file_cellar_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x22, 0xe9, 0x05, 0x0a, 0x06, 0x43,
	...
	,
	...
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x09, 0x72, 0x65, 0x62, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x74, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x48, 0x00, 0x52, 0x09, 0x72, 0x65, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x6b,
	...
	0x76, 0x32, 0x2e, 0x53, 0x65, 0x74, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	,
	...
	,
	...
	0x6f, 0x6c, 0x64, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x63,
	...
	0x4d, 0x69, 0x6e, 0x22, 0x80, 0x01, 0x0a, 0x0f, 0x55, 0x6e, 0x69, 0x56, 0x33, 0x53, 0x77, 0x61,
	...
	,
	...
	,
	...
	,
...
var file_cellar_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_cellar_proto_goTypes = []interface{}{
	...
	(*PopPosition)(nil),                // 4: steward.v2.PopPosition
	(*PushPosition)(nil),               // 5: steward.v2.PushPosition
	(*RemovePosition)(nil),             // 6: steward.v2.RemovePosition
	(*ReplacePosition)(nil),            // 7: steward.v2.ReplacePosition
	(*SetHoldingPosition)(nil),         // 8: steward.v2.SetHoldingPosition
	(*UniV2SwapParams)(nil),            // 9: steward.v2.UniV2SwapParams
	(*UniV3SwapParams)(nil),            // 10: steward.v2.UniV3SwapParams
	(*SwapParams)(nil),                 // 11: steward.v2.SwapParams
	(*Rebalance)(nil),                  // 12: steward.v2.Rebalance
	(*SetStrategistPayoutAddress)(nil), // 13: steward.v2.SetStrategistPayoutAddress
	(*SetWithdrawType)(nil),            // 14: steward.v2.SetWithdrawType
	(*SwapPositions)(nil),              // 15: steward.v2.SwapPositions
}
var file_cellar_proto_depIdxs = []int32{
	3,  // 0: steward.v2.Cellar.add_position:type_name -> steward.v2.AddPosition
	4,  // 1: steward.v2.Cellar.pop_position:type_name -> steward.v2.PopPosition
	5,  // 2: steward.v2.Cellar.push_position:type_name -> steward.v2.PushPosition
	6,  // 3: steward.v2.Cellar.remove_position:type_name -> steward.v2.RemovePosition
	7,  // 4: steward.v2.Cellar.replace_position:type_name -> steward.v2.ReplacePosition
	8,  // 5: steward.v2.Cellar.set_holding_position:type_name -> steward.v2.SetHoldingPosition
	12, // 6: steward.v2.Cellar.rebalance:type_name -> steward.v2.Rebalance
	13, // 7: steward.v2.Cellar.set_strategist_payout_address:type_name -> steward.v2.SetStrategistPayoutAddress
	14, // 8: steward.v2.Cellar.set_withdraw_type:type_name -> steward.v2.SetWithdrawType
	15, // 9: steward.v2.Cellar.swap_positions:type_name -> steward.v2.SwapPositions
	9,  // 10: steward.v2.SwapParams.univ2_params:type_name -> steward.v2.UniV2SwapParams
	10, // 11: steward.v2.SwapParams.univ3_params:type_name -> steward.v2.UniV3SwapParams
	0,  // 12: steward.v2.Rebalance.exchange:type_name -> steward.v2.Exchange
	11, // 13: steward.v2.Rebalance.params:type_name -> steward.v2.SwapParams
	1,  // 14: steward.v2.SetWithdrawType.new_withdraw_type:type_name -> steward.v2.WithdrawType
...
func file_cellar_proto_init() {
	...
	file_cellar_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Cellar_PopPosition)(nil),
		(*Cellar_PushPosition)(nil),
		(*Cellar_RemovePosition)(nil),
		(*Cellar_ReplacePosition)(nil),
	...
	file_cellar_proto_msgTypes[9].OneofWrappers = []interface{}{
