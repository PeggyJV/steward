...
type CellarV2_AdaptorCall struct {
	...
	//	*CellarV2_AdaptorCall_BaseCalls
...
func (x *CellarV2_AdaptorCall) GetBaseCalls() *BaseAdaptorCalls {
	if x, ok := x.GetCallData().(*CellarV2_AdaptorCall_BaseCalls); ok {
		return x.BaseCalls
	}
	return nil
}
...
type CellarV2_AdaptorCall_BaseCalls struct {
	// Represents base adaptor function calls native to all adaptors
	BaseCalls *BaseAdaptorCalls `protobuf:"bytes,2,opt,name=base_calls,json=baseCalls,proto3,oneof"`
}

type CellarV2_AdaptorCall_UniswapV3Calls struct {
	// Represents function calls to the UniswapV3Adaptor
	UniswapV3Calls *UniswapV3AdaptorCalls `protobuf:"bytes,3,opt,name=uniswap_v3_calls,json=uniswapV3Calls,proto3,oneof"`
}

type CellarV2_AdaptorCall_AaveATokenCalls struct {
	// Represents function calls to the AaveATokenAdaptor
	AaveATokenCalls *AaveATokenAdaptorCalls `protobuf:"bytes,4,opt,name=aave_a_token_calls,json=aaveATokenCalls,proto3,oneof"`
}

type CellarV2_AdaptorCall_AaveDebtTokenCalls struct {
	// Represents function calls to the AavaDebtTokenAdaptor
	AaveDebtTokenCalls *AaveDebtTokenAdaptorCalls `protobuf:"bytes,5,opt,name=aave_debt_token_calls,json=aaveDebtTokenCalls,proto3,oneof"`
}

type CellarV2_AdaptorCall_CompoundCTokenCalls struct {
	// Represents function calls to the CompoundCTokenAdaptor
	CompoundCTokenCalls *CompoundCTokenAdaptorCalls `protobuf:"bytes,6,opt,name=compound_c_token_calls,json=compoundCTokenCalls,proto3,oneof"`
}

type CellarV2_AdaptorCall_VestingSimpleCalls struct {
	// Represents function calls to the VestingSimpleAdaptor
	VestingSimpleCalls *VestingSimpleAdaptorCalls `protobuf:"bytes,7,opt,name=vesting_simple_calls,json=vestingSimpleCalls,proto3,oneof"`
}

func (*CellarV2_AdaptorCall_BaseCalls) isCellarV2_AdaptorCall_CallData() {}
...
var file_cellar_v2_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x1b, 0x61, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x73, 0x2f, 0x61, 0x61, 0x76,
	0x65, 0x2f, 0x61, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x1e, 0x61, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x73, 0x2f, 0x61, 0x61, 0x76, 0x65, 0x2f, 0x64,
	0x65, 0x62, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	0x1f, 0x61, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x75,
	0x6e, 0x64, 0x2f, 0x63, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	,
	...
	0x72, 0x56, 0x32, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0e, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x6f, 0x73, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5b, 0x0a, 0x14, 0x73, 0x65, 0x74, 0x5f, 0x68, 0x6f, 0x6c, 0x64,
	0x69, 0x6e, 0x67, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e,
	0x43, 0x65, 0x6c, 0x6c, 0x61, 0x72, 0x56, 0x32, 0x2e, 0x53, 0x65, 0x74, 0x48, 0x6f, 0x6c, 0x64,
	...
	0x6e, 0x12, 0x74, 0x0a, 0x1d, 0x73, 0x65, 0x74, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x5f, 0x70, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x65, 0x6c, 0x6c, 0x61, 0x72, 0x56, 0x32, 0x2e, 0x53,
	...
	,
	...
	0x65, 0x44, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5c, 0x0a, 0x15, 0x73, 0x65,
	0x74, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x5f, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x70, 0x65, 0x72,
	0x69, 0x6f, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x74, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x65, 0x6c, 0x6c, 0x61, 0x72, 0x56, 0x32, 0x2e,
	...
	0x63, 0x6b, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x1a, 0x97, 0x01, 0x0a, 0x0b, 0x41, 0x64, 0x64,
	...
	,
	...
	0x1a, 0x45, 0x0a, 0x0d, 0x43, 0x61, 0x6c, 0x6c, 0x4f, 0x6e, 0x41, 0x64, 0x61, 0x70, 0x74, 0x6f,
	0x72, 0x12, 0x34, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x20, 0x2e, 0x73, 0x74, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x65, 0x6c,
	0x6c, 0x61, 0x72, 0x56, 0x32, 0x2e, 0x41, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x43, 0x61, 0x6c,
	...
	0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0a, 0x0a, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69,
...
var file_cellar_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cellar_v2_proto_goTypes = []interface{}{
	...
	(*CellarV2_AdaptorCall)(nil),                // 2: steward.v2.CellarV2.AdaptorCall
	(*CellarV2_CallOnAdaptor)(nil),              // 3: steward.v2.CellarV2.CallOnAdaptor
	(*CellarV2_RemovePosition)(nil),             // 4: steward.v2.CellarV2.RemovePosition
	...
	(*CellarV2_SetShareLockPeriod)(nil),         // 8: steward.v2.CellarV2.SetShareLockPeriod
	(*CellarV2_SetRebalanceDeviation)(nil),      // 9: steward.v2.CellarV2.SetRebalanceDeviation
	(*BaseAdaptorCalls)(nil),                    // 10: steward.v2.BaseAdaptorCalls
...
var file_cellar_v2_proto_depIdxs = []int32{
	...
	3,  // 1: steward.v2.CellarV2.call_on_adaptor:type_name -> steward.v2.CellarV2.CallOnAdaptor
	4,  // 2: steward.v2.CellarV2.remove_position:type_name -> steward.v2.CellarV2.RemovePosition
	...
	9,  // 6: steward.v2.CellarV2.set_rebalance_deviation:type_name -> steward.v2.CellarV2.SetRebalanceDeviation
	8,  // 7: steward.v2.CellarV2.set_share_lock_period:type_name -> steward.v2.CellarV2.SetShareLockPeriod
	10, // 8: steward.v2.CellarV2.AdaptorCall.base_calls:type_name -> steward.v2.BaseAdaptorCalls
	11, // 9: steward.v2.CellarV2.AdaptorCall.uniswap_v3_calls:type_name -> steward.v2.UniswapV3AdaptorCalls
	12, // 10: steward.v2.CellarV2.AdaptorCall.aave_a_token_calls:type_name -> steward.v2.AaveATokenAdaptorCalls
	13, // 11: steward.v2.CellarV2.AdaptorCall.aave_debt_token_calls:type_name -> steward.v2.AaveDebtTokenAdaptorCalls
	14, // 12: steward.v2.CellarV2.AdaptorCall.compound_c_token_calls:type_name -> steward.v2.CompoundCTokenAdaptorCalls
	15, // 13: steward.v2.CellarV2.AdaptorCall.vesting_simple_calls:type_name -> steward.v2.VestingSimpleAdaptorCalls
	2,  // 14: steward.v2.CellarV2.CallOnAdaptor.data:type_name -> steward.v2.CellarV2.AdaptorCall
...
func file_cellar_v2_proto_init() {
	...
	file_cellar_v2_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*CellarV2_AdaptorCall_BaseCalls)(nil),
