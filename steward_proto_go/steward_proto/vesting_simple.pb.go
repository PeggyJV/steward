...
var file_vesting_simple_proto_rawDesc = []byte{
	...
	0x76, 0x34, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9,
	...
	0x76, 0x34, 0x2e, 0x53, 0x77, 0x61, 0x70, 0x48, 0x00, 0x52, 0x04, 0x73, 0x77, 0x61, 0x70, 0x12,
	...
	0x34, 0x2e, 0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x53, 0x77, 0x61, 0x70, 0x48, 0x00, 0x52, 0x0a,
...
var file_vesting_simple_proto_goTypes = []interface{}{
	(*VestingSimpleAdaptor)(nil),                        // 0: steward.v4.VestingSimpleAdaptor
	(*VestingSimpleAdaptorCalls)(nil),                   // 1: steward.v4.VestingSimpleAdaptorCalls
	(*VestingSimpleAdaptor_DepositToVesting)(nil),       // 2: steward.v4.VestingSimpleAdaptor.DepositToVesting
	(*VestingSimpleAdaptor_WithdrawFromVesting)(nil),    // 3: steward.v4.VestingSimpleAdaptor.WithdrawFromVesting
	(*VestingSimpleAdaptor_WithdrawAnyFromVesting)(nil), // 4: steward.v4.VestingSimpleAdaptor.WithdrawAnyFromVesting
	(*VestingSimpleAdaptor_WithdrawAllFromVesting)(nil), // 5: steward.v4.VestingSimpleAdaptor.WithdrawAllFromVesting
...
var file_vesting_simple_proto_depIdxs = []int32{
	6, // 0: steward.v4.VestingSimpleAdaptor.swap:type_name -> steward.v4.Swap
	7, // 1: steward.v4.VestingSimpleAdaptor.oracle_swap:type_name -> steward.v4.OracleSwap
	8, // 2: steward.v4.VestingSimpleAdaptor.revoke_approval:type_name -> steward.v4.RevokeApproval
	2, // 3: steward.v4.VestingSimpleAdaptor.deposit_to_vesting:type_name -> steward.v4.VestingSimpleAdaptor.DepositToVesting
	3, // 4: steward.v4.VestingSimpleAdaptor.withdraw_from_vesting:type_name -> steward.v4.VestingSimpleAdaptor.WithdrawFromVesting
	4, // 5: steward.v4.VestingSimpleAdaptor.withdraw_any_from_vesting:type_name -> steward.v4.VestingSimpleAdaptor.WithdrawAnyFromVesting
	5, // 6: steward.v4.VestingSimpleAdaptor.withdraw_all_from_vesting:type_name -> steward.v4.VestingSimpleAdaptor.WithdrawAllFromVesting
	0, // 7: steward.v4.VestingSimpleAdaptorCalls.calls:type_name -> steward.v4.VestingSimpleAdaptor
