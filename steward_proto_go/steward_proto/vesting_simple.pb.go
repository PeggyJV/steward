...
type VestingSimpleAdaptor_DepositToVesting_ struct {
	...
	DepositToVesting *VestingSimpleAdaptor_DepositToVesting `protobuf:"bytes,1,opt,name=deposit_to_vesting,json=depositToVesting,proto3,oneof"`
}
...
type VestingSimpleAdaptor_WithdrawFromVesting_ struct {
	...
	WithdrawFromVesting *VestingSimpleAdaptor_WithdrawFromVesting `protobuf:"bytes,2,opt,name=withdraw_from_vesting,json=withdrawFromVesting,proto3,oneof"`
}
...
type VestingSimpleAdaptor_WithdrawAnyFromVesting_ struct {
	...
	WithdrawAnyFromVesting *VestingSimpleAdaptor_WithdrawAnyFromVesting `protobuf:"bytes,3,opt,name=withdraw_any_from_vesting,json=withdrawAnyFromVesting,proto3,oneof"`
}
...
type VestingSimpleAdaptor_WithdrawAllFromVesting_ struct {
	...
	WithdrawAllFromVesting *VestingSimpleAdaptor_WithdrawAllFromVesting `protobuf:"bytes,4,opt,name=withdraw_all_from_vesting,json=withdrawAllFromVesting,proto3,oneof"`
}
...
var file_adaptors_vesting_simple_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x16,
	0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x77, 0x0a, 0x13, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72,
	0x61, 0x77, 0x46, 0x72, 0x6f, 0x6d, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x29, 0x0a,
	...
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x64, 0x65, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x1a,
	0x5b, 0x0a, 0x16, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x41, 0x6e, 0x79, 0x46, 0x72,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x43, 0x0a, 0x16,
	0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x41, 0x6c, 0x6c, 0x46, 0x72, 0x6f, 0x6d, 0x56,
	...
	0x74, 0x42, 0x0a, 0x0a, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x53, 0x0a,
	0x19, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x41, 0x64,
	0x61, 0x70, 0x74, 0x6f, 0x72, 0x43, 0x61, 0x6c, 0x6c, 0x73, 0x12, 0x36, 0x0a, 0x05, 0x63, 0x61,
	0x6c, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x73, 0x74, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x2e, 0x76, 0x32, 0x2e, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x69,
	0x6d, 0x70, 0x6c, 0x65, 0x41, 0x64, 0x61, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x05, 0x63, 0x61, 0x6c,
...
var file_adaptors_vesting_simple_proto_depIdxs = []int32{
	2, // 0: steward.v2.VestingSimpleAdaptor.deposit_to_vesting:type_name -> steward.v2.VestingSimpleAdaptor.DepositToVesting
	3, // 1: steward.v2.VestingSimpleAdaptor.withdraw_from_vesting:type_name -> steward.v2.VestingSimpleAdaptor.WithdrawFromVesting
	4, // 2: steward.v2.VestingSimpleAdaptor.withdraw_any_from_vesting:type_name -> steward.v2.VestingSimpleAdaptor.WithdrawAnyFromVesting
	5, // 3: steward.v2.VestingSimpleAdaptor.withdraw_all_from_vesting:type_name -> steward.v2.VestingSimpleAdaptor.WithdrawAllFromVesting
	0, // 4: steward.v2.VestingSimpleAdaptorCalls.calls:type_name -> steward.v2.VestingSimpleAdaptor
