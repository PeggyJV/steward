...
use steward_abi::aave_v2_enable_asset_as_collateral_adaptor_v1::AaveV2EnableAssetAsCollateralAdaptorV1Calls as AbiAaveV2EnableAssetAsCollateralAdaptorV1Calls;
use steward_proto::steward::aave_v2_enable_asset_as_collateral_adaptor_v1;
