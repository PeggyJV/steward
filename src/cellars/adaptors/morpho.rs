...
pub(crate) fn morpho_aave_v2_a_token_adaptor_v1_calls(
    params: crate::proto::MorphoAaveV2aTokenAdaptorV1Calls,
...
pub(crate) fn morpho_aave_v2_debt_token_adaptor_v1_calls(
    params: crate::proto::MorphoAaveV2DebtTokenAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_aave_v3_a_token_collateral_adaptor_v1_calls(
    params: crate::proto::MorphoAaveV3aTokenCollateralAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_aave_v3_a_token_p2p_adaptor_v1_calls(
    params: crate::proto::MorphoAaveV3aTokenP2pAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_aave_v3_debt_token_adaptor_v1_calls(
    params: crate::proto::MorphoAaveV3DebtTokenAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_blue_collateral_adaptor_v1_calls(
    params: crate::proto::MorphoBlueCollateralAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_blue_debt_adaptor_v1_calls(
    params: crate::proto::MorphoBlueDebtAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
...
pub(crate) fn morpho_blue_supply_adaptor_v1_calls(
    params: crate::proto::MorphoBlueSupplyAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
