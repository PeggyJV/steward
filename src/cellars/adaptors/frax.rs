...
pub(crate) fn debt_f_token_adaptor_v1_calls(
    params: crate::proto::DebtFTokenAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
        ...
        match function {
            crate::proto::debt_f_token_adaptor_v1::Function::RevokeApproval(p) => {
            ...
            crate::proto::debt_f_token_adaptor_v1::Function::BorrowFromFraxlend(p) => {
            ...
            crate::proto::debt_f_token_adaptor_v1::Function::RepayFraxlendDebt(p) => {
            ...
            crate::proto::debt_f_token_adaptor_v1::Function::CallAddInterest(p) => {
...
pub(crate) fn collateral_f_token_adaptor_v1_calls(
    params: crate::proto::CollateralFTokenAdaptorV1Calls,
) -> Result<Vec<Bytes>, Error> {
    let mut calls = Vec::new();
    for c in params.calls {
        let function = c
        ...
        match function {
            crate::proto::collateral_f_token_adaptor_v1::Function::RevokeApproval(p) => {
            ...
            crate::proto::collateral_f_token_adaptor_v1::Function::AddCollateral(p) => {
            ...
            crate::proto::collateral_f_token_adaptor_v1::Function::RemoveCollateral(p) => {
