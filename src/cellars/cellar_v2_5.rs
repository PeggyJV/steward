...
use crate::proto::{
    ...
    cellar_v2_5governance::{function_call::Function as GovernanceFunction, CallType as GovernanceCallType, FunctionCall as GovernanceFunctionCall},
    AdaptorCall,
};
...
pub fn get_encoded_function(call: FunctionCall, cellar_id: String) -> Result<Vec<u8>, Error> {
    ...
    match function {
        ...
        Function::SetStrategistPayoutAddress(params) => {
            ...
            Ok(CellarV2_5Calls::SetStrategistPayoutAddress(call).encode())
        }
        Function::SwapPositions(params) => {
            ...
            Ok(CellarV2_5Calls::SwapPositions(call).encode())
        }
        ...
        Function::SetSharePriceOracle(params) => {
            validate_oracle(&cellar_id, &params.registry_id, &params.share_price_oracle)?;
            log_cellar_call(
                CELLAR_NAME,
...
/// Encodes a Governance call to a CellarV2.5 contract
pub fn get_encoded_governance_call(call_type: GovernanceCallType, cellar_id: String, proposal_id: u64) -> Result<Vec<u8>, Error> {
    match call_type {
        GovernanceCallType::FunctionCall(f) => get_encoded_governance_function(f, &cellar_id, proposal_id),
...
pub fn get_encoded_governance_function(
    ...
    match function {
        ...
        GovernanceFunction::ToggleIgnorePause(_) => {
            log_governance_cellar_call(
                proposal_id,
                CELLAR_NAME,
