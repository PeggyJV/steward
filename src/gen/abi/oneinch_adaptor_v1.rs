...
pub mod one_inch_adaptor_v1 {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("swapWithOneInch"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("swapWithOneInch"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("swapCallData"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Bytes,
                                    internal_type: ::core::option::Option::Some(
                                        ::std::borrow::ToOwned::to_owned("bytes"),
                                    ),
    ...
    pub static ONEINCHADAPTORV1_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[Pa\x0E\x9F\x80a\0 `\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\0\xB4W`\x005`\xE0\x1C\x80c\xC9\x11\x1B\xD7\x11a\0qW\x80c\xC9\x11\x1B\xD7\x14a\x01<W\x80c\xD3\xBF\xE7j\x14a\x01OW\x80c\xD4\xB89\x92\x14a\x01bW\x80c\xD8\x05\xA6W\x14a\x01\x90W\x80c\xE1p\xA9\xBF\x14a\x01\xA3W\x80c\xFAP\xE5\xD2\x14a\x01\xB1W`\0\x80\xFD[\x80c>\x03*;\x14a\0\xB9W\x80ciD\\1\x14a\0\xCEW\x80cxASe\x14a\0\xE3W\x80cy\x98\xA1\xC4\x14a\x01\x05W\x80c\x895:\t\x14a\x01\rW\x80c\xAE\xFF\xDD\xDE\x14a\x01\x1CW[`\0\x80\xFD[`@Qa#(\x81R` \x01[`@Q\x80\x91\x03\x90\xF3[a\0\xE1a\0\xDC6`\x04a\n\xE3V[a\x01\xC4V[\0[a\0\xF7a\0\xF16`\x04a\x0BPV[P`\0\x90V[`@Q\x90\x81R` \x01a\0\xC5V[a\0\xF7a\x01\xDDV[`@Q`\0\x81R` \x01a\0\xC5V[a\x01/a\x01*6`\x04a\x0BPV[a\x021V[`@Qa\0\xC5\x91\x90a\x0B\x85V[a\0\xE1a\x01J6`\x04a\x0B\xEAV[a\x02\x8DV[a\0\xE1a\x01]6`\x04a\x0CjV[a\x02\xA6V[s\x11\x11\x11\x12T\xEE\xB2Tw\xB6\x8F\xB8^\xD9)\xF7:\x96\x05\x82[`@Q`\x01`\x01`\xA0\x1B\x03\x90\x91\x16\x81R` \x01a\0\xC5V[a\0\xE1a\x01\x9E6`\x04a\x0C\xA3V[a\x02\xBFV[a\x01xa\0\xF16`\x04a\x0BPV[a\0\xF7a\x01\xBF6`\x04a\r\x03V[a\x07FV[`@Qc2\x04\xED[`\xE2\x1B\x81R`\x04\x01`@Q\x80\x91\x03\x90\xFD[`\0`@Q` \x01a\x02\x16\x90` \x80\x82R`\x13\x90\x82\x01Rr\x03\x14\x96\xE66\x82\x04\x16F\x17\x07F\xF7\"\x05b\x03\x12\xE3`l\x1B`@\x82\x01R``\x01\x90V[`@Q` \x81\x83\x03\x03\x81R\x90`@R\x80Q\x90` \x01 \x90P\x90V[`@\x80Q`\x01\x80\x82R\x81\x83\x01\x90\x92R``\x91` \x80\x83\x01\x90\x806\x837\x01\x90PP\x90P`\0\x81`\0\x81Q\x81\x10a\x02hWa\x02ha\rgV[` \x02` \x01\x01\x90`\x01`\x01`\xA0\x1B\x03\x16\x90\x81`\x01`\x01`\xA0\x1B\x03\x16\x81RPP\x91\x90PV[`@Qc_P\x03\xC5`\xE1\x1B\x81R`\x04\x01`@Q\x80\x91\x03\x90\xFD[a\x02\xBB`\x01`\x01`\xA0\x1B\x03\x83\x16\x82`\0a\x07OV[PPV[`\x000`\x01`\x01`\xA0\x1B\x03\x16c\xD7\xD4\xBFE`@Q\x81c\xFF\xFF\xFF\xFF\x16`\xE0\x1B\x81R`\x04\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x02\xFFW=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x03#\x91\x90a\r}V[\x90Pa\x03M`\x01`\x01`\xA0\x1B\x03\x86\x16s\x11\x11\x11\x12T\xEE\xB2Tw\xB6\x8F\xB8^\xD9)\xF7:\x96\x05\x82\x85a\x07OV[`@QcO\x12\x9CS`\xE0\x1B\x81R`\x01`\x01`\xA0\x1B\x03\x86\x81\x16`\x04\x83\x01R\x82\x16\x90cO\x12\x9CS\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x03\x93W=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x03\xB7\x91\x90a\r\x9AV[\x15a\x07\x01W`@QcO\x12\x9CS`\xE0\x1B\x81R`\x01`\x01`\xA0\x1B\x03\x85\x81\x16`\x04\x83\x01R\x82\x16\x90cO\x12\x9CS\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x04\x02W=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x04&\x91\x90a\r\x9AV[a\x04SW`@Qcz\xB28I`\xE0\x1B\x81R`\x01`\x01`\xA0\x1B\x03\x85\x16`\x04\x82\x01R`$\x01[`@Q\x80\x91\x03\x90\xFD[`@Qcp\xA0\x821`\xE0\x1B\x81R0`\x04\x82\x01R`\0\x90`\x01`\x01`\xA0\x1B\x03\x87\x16\x90cp\xA0\x821\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x04\x9AW=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x04\xBE\x91\x90a\r\xBCV[`@Qcp\xA0\x821`\xE0\x1B\x81R0`\x04\x82\x01R\x90\x91P`\0\x90`\x01`\x01`\xA0\x1B\x03\x87\x16\x90cp\xA0\x821\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x05\x08W=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x05,\x91\x90a\r\xBCV[\x90Pa\x05W\x84s\x11\x11\x11\x12T\xEE\xB2Tw\xB6\x8F\xB8^\xD9)\xF7:\x96\x05\x82[`\x01`\x01`\xA0\x1B\x03\x16\x90a\x07\xCCV[P`@Qcp\xA0\x821`\xE0\x1B\x81R0`\x04\x82\x01R`\0\x90`\x01`\x01`\xA0\x1B\x03\x89\x16\x90cp\xA0\x821\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x05\x9FW=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x05\xC3\x91\x90a\r\xBCV[a\x05\xCD\x90\x84a\r\xD5V[`@Qcp\xA0\x821`\xE0\x1B\x81R0`\x04\x82\x01R\x90\x91P`\0\x90\x83\x90`\x01`\x01`\xA0\x1B\x03\x8A\x16\x90cp\xA0\x821\x90`$\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x06\x19W=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x06=\x91\x90a\r\xBCV[a\x06G\x91\x90a\r\xD5V[`@Qc\x15\x1DJY`\xE3\x1B\x81R`\x01`\x01`\xA0\x1B\x03\x8A\x81\x16`\x04\x83\x01R`$\x82\x01\x83\x90R\x8B\x81\x16`D\x83\x01R\x91\x92P`\0\x91\x87\x16\x90c\xA8\xEAR\xC8\x90`d\x01` `@Q\x80\x83\x03\x81\x86Z\xFA\x15\x80\x15a\x06\xA2W=`\0\x80>=`\0\xFD[PPPP`@Q=`\x1F\x19`\x1F\x82\x01\x16\x82\x01\x80`@RP\x81\x01\x90a\x06\xC6\x91\x90a\r\xBCV[\x90Pa\x06\xD7\x83a#(a'\x10a\x08\x17V[\x81\x10\x15a\x06\xF7W`@Qc\x1E\xA0\xEB\x01`\xE2\x1B\x81R`\x04\x01`@Q\x80\x91\x03\x90\xFD[PPPPPa\x07!V[a\x07\x1F\x82s\x11\x11\x11\x12T\xEE\xB2Tw\xB6\x8F\xB8^\xD9)\xF7:\x96\x05\x82a\x05HV[P[a\x07?\x85s\x11\x11\x11\x12T\xEE\xB2Tw\xB6\x8F\xB8^\xD9)\xF7:\x96\x05\x82a\x086V[PPPPPV[`\0[\x92\x91PPV[`\0`@Qc\t^\xA7\xB3`\xE0\x1B\x81R\x83`\x04\x82\x01R\x82`$\x82\x01R` `\0`D\x83`\0\x89Z\xF1=\x15`\x1F=\x11`\x01`\0Q\x14\x16\x17\x16\x91PP\x80a\x07\xC6W`@QbF\x1B\xCD`\xE5\x1B\x81R` `\x04\x82\x01R`\x0E`$\x82\x01Rm\x10T\x14\x14\x93\xD5\x91W\xD1\x90RS\x11Q`\x92\x1B`D\x82\x01R`d\x01a\x04JV[PPPPV[``a\x08\x10\x83\x83`\0`@Q\x80`@\x01`@R\x80`\x1E\x81R` \x01\x7FAddress: low-level call failed\0\0\x81RPa\x08\xC5V[\x93\x92PPPV[\x82\x82\x02\x81\x15\x15\x84\x15\x85\x83\x04\x85\x14\x17\x
M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                ONEINCHADAPTORV1_ABI.clone(),
                ONEINCHADAPTORV1_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `swapWithOneInch` (0xd805a657) function
        pub fn swap_with_one_inch(
            &self,
            token_in: ::ethers::core::types::Address,
            token_out: ::ethers::core::types::Address,
            amount: ::ethers::core::types::U256,
            swap_call_data: ::ethers::core::types::Bytes,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash(
                    [216, 5, 166, 87],
                    (token_in, token_out, amount, swap_call_data),
                )
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `target` (0xd4b83992) function
        pub fn target(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
            M,
    ...
    pub enum OneInchAdaptorV1Errors {
    ...
    impl ::ethers::core::abi::AbiDecode for OneInchAdaptorV1Errors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for OneInchAdaptorV1Errors {
    ...
    impl ::ethers::contract::ContractRevert for OneInchAdaptorV1Errors {
    ...
    impl ::core::fmt::Display for OneInchAdaptorV1Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::BaseAdaptor__ExternalReceiverBlocked(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for OneInchAdaptorV1Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BaseAdaptor__ExternalReceiverBlocked>
    for OneInchAdaptorV1Errors {
    ...
    impl ::core::convert::From<BaseAdaptor__Slippage> for OneInchAdaptorV1Errors {
    ...
    ///Container type for all input parameters for the `swapWithOneInch` function with signature `swapWithOneInch(address,address,uint256,bytes)` and selector `0xd805a657`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "swapWithOneInch(address,address,uint256,bytes)"
    )]
    pub struct SwapWithOneInchCall {
        pub token_in: ::ethers::core::types::Address,
        pub token_out: ::ethers::core::types::Address,
        pub amount: ::ethers::core::types::U256,
        pub swap_call_data: ::ethers::core::types::Bytes,
    }
    ///Container type for all input parameters for the `target` function with signature `target()` and selector `0xd4b83992`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    pub enum OneInchAdaptorV1Calls {
        AssetOf(AssetOfCall),
        ...
        SwapWithOneInch(SwapWithOneInchCall),
        Target(TargetCall),
        Withdraw(WithdrawCall),
        WithdrawableFrom(WithdrawableFromCall),
    }
    impl ::ethers::core::abi::AbiDecode for OneInchAdaptorV1Calls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded) = <SwapWithOneInchCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SwapWithOneInch(decoded));
            }
            if let Ok(decoded) = <TargetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for OneInchAdaptorV1Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::SwapWithOneInch(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Target(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for OneInchAdaptorV1Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SwapWithOneInch(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<AssetOfCall> for OneInchAdaptorV1Calls {
        fn from(value: AssetOfCall) -> Self {
            Self::AssetOf(value)
        }
    }
    impl ::core::convert::From<AssetsUsedCall> for OneInchAdaptorV1Calls {
        fn from(value: AssetsUsedCall) -> Self {
            Self::AssetsUsed(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for OneInchAdaptorV1Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<DepositCall> for OneInchAdaptorV1Calls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<IdentifierCall> for OneInchAdaptorV1Calls {
        fn from(value: IdentifierCall) -> Self {
            Self::Identifier(value)
        }
    }
    impl ::core::convert::From<IsDebtCall> for OneInchAdaptorV1Calls {
        fn from(value: IsDebtCall) -> Self {
            Self::IsDebt(value)
        }
    }
    impl ::core::convert::From<RevokeApprovalCall> for OneInchAdaptorV1Calls {
        fn from(value: RevokeApprovalCall) -> Self {
            Self::RevokeApproval(value)
        }
    }
    impl ::core::convert::From<SlippageCall> for OneInchAdaptorV1Calls {
        fn from(value: SlippageCall) -> Self {
            Self::Slippage(value)
        }
    }
    impl ::core::convert::From<SwapWithOneInchCall> for OneInchAdaptorV1Calls {
        fn from(value: SwapWithOneInchCall) -> Self {
            Self::SwapWithOneInch(value)
        }
    }
    impl ::core::convert::From<TargetCall> for OneInchAdaptorV1Calls {
        fn from(value: TargetCall) -> Self {
            Self::Target(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for OneInchAdaptorV1Calls {
        fn from(value: WithdrawCall) -> Self {
            Self::Withdraw(value)
        }
    }
    impl ::core::convert::From<WithdrawableFromCall> for OneInchAdaptorV1Calls {
    ...
    ///Container type for all return fields from the `target` function with signature `target()` and selector `0xd4b83992`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
