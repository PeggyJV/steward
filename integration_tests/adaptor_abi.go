...
// FlashLoan is a paid mutator transaction binding the contract method 0x788fb484.
//
// Solidity: function flashLoan(address[] loanToken, uint256[] loanAmount, bytes params) returns()
func (_Adaptor *AdaptorTransactor) FlashLoan(opts *bind.TransactOpts, loanToken []common.Address, loanAmount []*big.Int, params []byte) (*types.Transaction, error) {
	return _Adaptor.contract.Transact(opts, "flashLoan", loanToken, loanAmount, params)
}

// FlashLoan is a paid mutator transaction binding the contract method 0x788fb484.
//
// Solidity: function flashLoan(address[] loanToken, uint256[] loanAmount, bytes params) returns()
func (_Adaptor *AdaptorSession) FlashLoan(loanToken []common.Address, loanAmount []*big.Int, params []byte) (*types.Transaction, error) {
	return _Adaptor.Contract.FlashLoan(&_Adaptor.TransactOpts, loanToken, loanAmount, params)
}

// FlashLoan is a paid mutator transaction binding the contract method 0x788fb484.
//
// Solidity: function flashLoan(address[] loanToken, uint256[] loanAmount, bytes params) returns()
func (_Adaptor *AdaptorTransactorSession) FlashLoan(loanToken []common.Address, loanAmount []*big.Int, params []byte) (*types.Transaction, error) {
	return _Adaptor.Contract.FlashLoan(&_Adaptor.TransactOpts, loanToken, loanAmount, params)
}
...
// AdaptorFlashLoanIterator is returned from FilterFlashLoan and is used to iterate over the raw logs and unpacked data for FlashLoan events raised by the Adaptor contract.
type AdaptorFlashLoanIterator struct {
	Event *AdaptorFlashLoan // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AdaptorFlashLoanIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AdaptorFlashLoanIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AdaptorFlashLoanIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AdaptorFlashLoan represents a FlashLoan event raised by the Adaptor contract.
type AdaptorFlashLoan struct {
...
// FilterFlashLoan is a free log retrieval operation binding the contract event 0x9fbcb54e2fedf70cdd17eea8dada1de3123bc15cc424b378738467a9d83c13d9.
//
// Solidity: event FlashLoan(address[] loanToken, uint256[] loanAmount, bytes params)
func (_Adaptor *AdaptorFilterer) FilterFlashLoan(opts *bind.FilterOpts) (*AdaptorFlashLoanIterator, error) {

	logs, sub, err := _Adaptor.contract.FilterLogs(opts, "FlashLoan")
	if err != nil {
		return nil, err
	}
	return &AdaptorFlashLoanIterator{contract: _Adaptor.contract, event: "FlashLoan", logs: logs, sub: sub}, nil
}

// WatchFlashLoan is a free log subscription operation binding the contract event 0x9fbcb54e2fedf70cdd17eea8dada1de3123bc15cc424b378738467a9d83c13d9.
//
// Solidity: event FlashLoan(address[] loanToken, uint256[] loanAmount, bytes params)
func (_Adaptor *AdaptorFilterer) WatchFlashLoan(opts *bind.WatchOpts, sink chan<- *AdaptorFlashLoan) (event.Subscription, error) {

	logs, sub, err := _Adaptor.contract.WatchLogs(opts, "FlashLoan")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AdaptorFlashLoan)
				if err := _Adaptor.contract.UnpackLog(event, "FlashLoan", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFlashLoan is a log parse operation binding the contract event 0x9fbcb54e2fedf70cdd17eea8dada1de3123bc15cc424b378738467a9d83c13d9.
//
// Solidity: event FlashLoan(address[] loanToken, uint256[] loanAmount, bytes params)
func (_Adaptor *AdaptorFilterer) ParseFlashLoan(log types.Log) (*AdaptorFlashLoan, error) {
	event := new(AdaptorFlashLoan)
	if err := _Adaptor.contract.UnpackLog(event, "FlashLoan", log); err != nil {
		return nil, err
	}
