...
- [cellar_v2.proto](#cellar_v2-proto)
    - [CellarV2](#steward-v2-CellarV2)
    - [CellarV2.AdaptorCall](#steward-v2-CellarV2-AdaptorCall)
    ...
    - [CellarV2.SwapPositions](#steward-v2-CellarV2-SwapPositions)
...
| ----- | ---- | ----- | ----------- |
| add_position | [CellarV2.AddPosition](#steward-v2-CellarV2-AddPosition) |  | Represents function `addPosition(uint256 index, address position)` |
| call_on_adaptor | [CellarV2.CallOnAdaptor](#steward-v2-CellarV2-CallOnAdaptor) |  | Represents function `callOnAdaptor(AdaptorCall[] memory data)` |
| remove_position | [CellarV2.RemovePosition](#steward-v2-CellarV2-RemovePosition) |  | Represents function `removePosition(uint256 index)` |
| set_holding_position | [CellarV2.SetHoldingPosition](#steward-v2-CellarV2-SetHoldingPosition) |  | Represents function `setHoldingPosition(uint32 position_id)` |
| set_strategist_payout_address | [CellarV2.SetStrategistPayoutAddress](#steward-v2-CellarV2-SetStrategistPayoutAddress) |  | Represents function `setStrategistPayoutAddress(address payout)` |
| swap_positions | [CellarV2.SwapPositions](#steward-v2-CellarV2-SwapPositions) |  | Represents function `swapPositions(uint256 index1, uint256 index2)` |
| set_rebalance_deviation | [CellarV2.SetRebalanceDeviation](#steward-v2-CellarV2-SetRebalanceDeviation) |  | Represents function `setRebalanceDeviation(uint265)` |
| set_share_lock_period | [CellarV2.SetShareLockPeriod](#steward-v2-CellarV2-SetShareLockPeriod) |  | Represents function `setShareLockPeriod(uint256 newLock)` |
...
<a name="steward-v2-CellarV2-AdaptorCall"></a>
...
| uniswap_v3_calls | [UniswapV3AdaptorCalls](#steward-v2-UniswapV3AdaptorCalls) |  | Represents function calls to the UniswapV3Adaptor |
| aave_a_token_calls | [AaveATokenAdaptorCalls](#steward-v2-AaveATokenAdaptorCalls) |  | Represents function calls to the AaveATokenAdaptor |
| aave_debt_token_calls | [AaveDebtTokenAdaptorCalls](#steward-v2-AaveDebtTokenAdaptorCalls) |  | Represents function calls to the AavaDebtTokenAdaptor |
| compound_c_token_calls | [CompoundCTokenAdaptorCalls](#steward-v2-CompoundCTokenAdaptorCalls) |  | Represents function calls to the CompoundCTokenAdaptor |
| vesting_simple_calls | [VestingSimpleAdaptorCalls](#steward-v2-VestingSimpleAdaptorCalls) |  | Represents function calls to the VestingSimpleAdaptor |
...
<a name="steward-v2-CellarV2-AddPosition"></a>
...
<a name="steward-v2-CellarV2-CallOnAdaptor"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| data | [CellarV2.AdaptorCall](#steward-v2-CellarV2-AdaptorCall) | repeated |  |
...
<a name="steward-v2-CellarV2-RemovePosition"></a>
...
<a name="steward-v2-CellarV2-SetHoldingPosition"></a>
...
<a name="steward-v2-CellarV2-SetRebalanceDeviation"></a>
...
<a name="steward-v2-CellarV2-SetShareLockPeriod"></a>
...
<a name="steward-v2-CellarV2-SetStrategistPayoutAddress"></a>
...
<a name="steward-v2-CellarV2-SwapPositions"></a>
