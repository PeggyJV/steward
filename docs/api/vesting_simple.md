...
- [adaptors/vesting_simple.proto](#adaptors_vesting_simple-proto)
    - [VestingSimpleAdaptor](#steward-v2-VestingSimpleAdaptor)
    - [VestingSimpleAdaptor.DepositToVesting](#steward-v2-VestingSimpleAdaptor-DepositToVesting)
    - [VestingSimpleAdaptor.WithdrawAllFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawAllFromVesting)
    - [VestingSimpleAdaptor.WithdrawAnyFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawAnyFromVesting)
    - [VestingSimpleAdaptor.WithdrawFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawFromVesting)
    - [VestingSimpleAdaptorCalls](#steward-v2-VestingSimpleAdaptorCalls)
...
<a name="steward-v2-VestingSimpleAdaptor"></a>
...
| deposit_to_vesting | [VestingSimpleAdaptor.DepositToVesting](#steward-v2-VestingSimpleAdaptor-DepositToVesting) |  | Represents function `depositToVesting(VestingSimple vestingContract, uint256 amountToDeposit)` |
| withdraw_from_vesting | [VestingSimpleAdaptor.WithdrawFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawFromVesting) |  | Represents function `withdrawFromVesting(VestingSimple vestingContract, uint256 depositId, uint256 amountToWithdraw)` |
| withdraw_any_from_vesting | [VestingSimpleAdaptor.WithdrawAnyFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawAnyFromVesting) |  | Represents function `withdrawAnyFromVesting(VestingSimple vestingContract, uint256 amountToWithdraw)` |
| withdraw_all_from_vesting | [VestingSimpleAdaptor.WithdrawAllFromVesting](#steward-v2-VestingSimpleAdaptor-WithdrawAllFromVesting) |  | Represents function `withdrawAllFromVesting(VestingSimple vestingContract)` |
...
<a name="steward-v2-VestingSimpleAdaptor-DepositToVesting"></a>
...
<a name="steward-v2-VestingSimpleAdaptor-WithdrawAllFromVesting"></a>
...
<a name="steward-v2-VestingSimpleAdaptor-WithdrawAnyFromVesting"></a>
...
<a name="steward-v2-VestingSimpleAdaptor-WithdrawFromVesting"></a>
...
<a name="steward-v2-VestingSimpleAdaptorCalls"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| calls | [VestingSimpleAdaptor](#steward-v2-VestingSimpleAdaptor) | repeated |  |
