...
impl Exchange {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "EXCHANGE_UNSPECIFIED",
            Self::Univ2 => "EXCHANGE_UNIV2",
            Self::Univ3 => "EXCHANGE_UNIV3",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "EXCHANGE_UNIV2" => Some(Self::Univ2),
            "EXCHANGE_UNIV3" => Some(Self::Univ3),
            _ => None,
        }
    }
}
...
pub struct AaveDebtTokenAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "aave_debt_token_adaptor_v1::Function", tags = "1, 2, 3, 4, 5, 6")]
...
pub struct PendleAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "pendle_adaptor_v1::Function", tags = "1, 2, 3, 4, 5, 6, 7, 8, 9")]
...
pub struct MorphoAaveV2aTokenAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "morpho_aave_v2a_token_adaptor_v1::Function", tags = "1, 2, 3, 4")]
...
pub struct MorphoAaveV3aTokenCollateralAdaptorV1 {
    ...
    pub function: ::core::option::Option<
        morpho_aave_v3a_token_collateral_adaptor_v1::Function,
    >,
}
...
pub struct MorphoAaveV2DebtTokenAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "morpho_aave_v2_debt_token_adaptor_v1::Function", tags = "1, 2, 3")]
...
pub struct MorphoAaveV3DebtTokenAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "morpho_aave_v3_debt_token_adaptor_v1::Function", tags = "1, 2, 3")]
...
pub struct MorphoBlueCollateralAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "morpho_blue_collateral_adaptor_v1::Function", tags = "1, 2, 3")]
...
pub struct AaveV2EnableAssetAsCollateralAdaptorV1 {
    ...
    pub function: ::core::option::Option<
        aave_v2_enable_asset_as_collateral_adaptor_v1::Function,
    >,
}
...
pub mod curve_adaptor_v1 {
    ...
    pub struct AddLiquidity {
        ...
        pub ordered_underlying_token_amounts: ::prost::alloc::vec::Vec<
    ...
    pub struct RemoveLiquidity {
        ...
        pub ordered_minimum_underlying_token_amounts_out: ::prost::alloc::vec::Vec<
            ::prost::alloc::string::String,
        >,
        /// Address of the Curve gauge
        #[prost(string, tag = "5")]
...
pub struct StakingAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "staking_adaptor_v1::Function", tags = "1, 2, 3, 4, 5, 6, 7, 8, 9")]
...
pub struct BalancerPoolAdaptorV1FlashLoan {
    #[prost(message, optional, tag = "1")]
    pub make_flash_loan: ::core::option::Option<
        balancer_pool_adaptor_v1_flash_loan::MakeFlashLoan,
    >,
}
    ...
    pub mod adaptor_call_for_balancer_pool_flash_loan {
        ...
        pub enum CallData {
            ...
            MorphoAaveV2DebtTokenV1Calls(
                super::super::MorphoAaveV2DebtTokenAdaptorV1Calls,
            ),
            ...
            MorphoAaveV3ATokenP2pV1Calls(
                super::super::MorphoAaveV3aTokenP2pAdaptorV1Calls,
            ),
            /// Represents function calls to the MorphoAaveV3DebtToken V1
            #[prost(message, tag = "22")]
            MorphoAaveV3DebtTokenV1Calls(
                super::super::MorphoAaveV3DebtTokenAdaptorV1Calls,
            ),
            ...
            MorphoBlueCollateralV1Calls(
                super::super::MorphoBlueCollateralAdaptorV1Calls,
            ),
...
pub struct AaveV2StablecoinGovernance {
    ...
    #[prost(oneof = "aave_v2_stablecoin_governance::Function", tags = "1, 2, 3, 4, 5")]
...
pub mod cellar_v1 {
    ...
    impl WithdrawType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "WITHDRAW_TYPE_UNSPECIFIED",
                Self::Orderly => "WITHDRAW_TYPE_ORDERLY",
                Self::Proportional => "WITHDRAW_TYPE_PROPORTIONAL",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "WITHDRAW_TYPE_UNSPECIFIED" => Some(Self::Unspecified),
                "WITHDRAW_TYPE_ORDERLY" => Some(Self::Orderly),
                "WITHDRAW_TYPE_PROPORTIONAL" => Some(Self::Proportional),
                _ => None,
            }
        }
    }
...
pub struct BalancerPoolAdaptorV1 {
    /// **** BASE ADAPTOR FUNCTIONS ****
    #[prost(oneof = "balancer_pool_adaptor_v1::Function", tags = "1, 2, 3, 4, 5, 6")]
...
pub mod balancer_pool_adaptor_v1 {
    ...
    pub struct SwapData {
        ...
        #[prost(string, repeated, tag = "1")]
        pub min_amounts_for_swaps: ::prost::alloc::vec::Vec<
            ::prost::alloc::string::String,
        >,
        /// The swap deadlines
        #[prost(string, repeated, tag = "2")]
    ...
    impl SwapKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "SWAP_KIND_UNSPECIFIED",
                Self::GivenIn => "SWAP_KIND_GIVEN_IN",
                Self::GivenOut => "SWAP_KIND_GIVEN_OUT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "SWAP_KIND_UNSPECIFIED" => Some(Self::Unspecified),
                "SWAP_KIND_GIVEN_IN" => Some(Self::GivenIn),
                "SWAP_KIND_GIVEN_OUT" => Some(Self::GivenOut),
                _ => None,
            }
        }
    }
...
pub struct AaveV3DebtTokenAdaptorV1FlashLoan {
    ...
    #[prost(message, optional, tag = "1")]
    pub flash_loan: ::core::option::Option<
        aave_v3_debt_token_adaptor_v1_flash_loan::FlashLoan,
    >,
}
...
pub mod aave_v3_debt_token_adaptor_v1_flash_loan {
    ...
    pub struct AdaptorCallForAaveV3FlashLoan {
        ...
        pub call_data: ::core::option::Option<
            adaptor_call_for_aave_v3_flash_loan::CallData,
        >,
    }
...
pub mod adaptor_call {
    ...
    pub enum CallData {
        ...
        #[prost(message, tag = "16")]
        AaveV2EnableAssetAsCollateralV1Calls(
            super::AaveV2EnableAssetAsCollateralAdaptorV1Calls,
        ),
        /// Represents function calls to the FTokenAdaptor V1
        #[prost(message, tag = "17")]
        ...
        #[prost(message, tag = "20")]
        MorphoAaveV3ATokenCollateralV1Calls(
            super::MorphoAaveV3aTokenCollateralAdaptorV1Calls,
        ),
        /// Represents function calls to the MorphoAaveV3ATokenP2P V1
        #[prost(message, tag = "21")]
...
pub mod contract_call_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ContractCallServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            ContractCallServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("steward.v4.ContractCallService", "Schedule"));
...
pub mod encoding_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> EncodingServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            EncodingServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn encode(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("steward.v4.EncodingService", "Encode"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod simulate_contract_call_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> SimulateContractCallServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            SimulateContractCallServiceClient::new(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("steward.v4.SimulateContractCallService", "Simulate"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod status_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("steward.v4.StatusService", "Version"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod contract_call_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ContractCallServiceServer.
    #[async_trait]
    pub trait ContractCallService: std::marker::Send + std::marker::Sync + 'static {
        /// Handles scheduled contract call submission
        async fn schedule(
            &self,
    ...
    /// Service for handling Cellar contract calls
    #[derive(Debug)]
    pub struct ContractCallServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> ContractCallServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ContractCallServiceServer<T>
    where
                ...
                "/steward.v4.ContractCallService/Schedule" => {
                    ...
                    for ScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ContractCallService>::schedule(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ContractCallServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "steward.v4.ContractCallService";
    impl<T> tonic::server::NamedService for ContractCallServiceServer<T> {
...
pub mod encoding_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with EncodingServiceServer.
    #[async_trait]
    pub trait EncodingService: std::marker::Send + std::marker::Sync + 'static {
        /// Handles contract call encoding
        async fn encode(
            &self,
    ...
    /// Service for testing contract call encoding. Simply returns the encoded call data in the response.
    #[derive(Debug)]
    pub struct EncodingServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> EncodingServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EncodingServiceServer<T>
    where
        T: EncodingService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/steward.v4.EncodingService/Encode" => {
                    ...
                    impl<
                        T: EncodingService,
                    > tonic::server::UnaryService<super::EncodeRequest>
                    for EncodeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EncodingService>::encode(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for EncodingServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "steward.v4.EncodingService";
    impl<T> tonic::server::NamedService for EncodingServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod simulate_contract_call_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SimulateContractCallServiceServer.
    #[async_trait]
    pub trait SimulateContractCallService: std::marker::Send + std::marker::Sync + 'static {
        /// Handles simulated contract call submission
        async fn simulate(
            &self,
    ...
    /// Service for simulating contract calls encoded by Steward using Tenderly
    #[derive(Debug)]
    pub struct SimulateContractCallServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SimulateContractCallServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/steward.v4.SimulateContractCallService/Simulate" => {
                    ...
                    impl<
                        T: SimulateContractCallService,
                    > tonic::server::UnaryService<super::SimulateRequest>
                    for SimulateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SimulateContractCallService>::simulate(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    impl<T> Clone for SimulateContractCallServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "steward.v4.SimulateContractCallService";
    impl<T> tonic::server::NamedService for SimulateContractCallServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod status_service_server {
                ...
                "/steward.v4.StatusService/Version" => {
                    ...
                    for VersionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StatusService>::version(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "steward.v4.StatusService";
