pub use morpho_blue_debt_adaptor_v1::*;
...
pub mod morpho_blue_debt_adaptor_v1 {
    const _: () = {
        ::core::include_bytes!(
            "../abi/MorphoBlueDebtAdaptorV1.json",
        );
    };
    #[allow(deprecated)]
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("borrowFromMorphoBlue"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("_amountToBorrow"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Uint(
                                        256usize,
                                    ),
                                    internal_type: ::core::option::Option::Some(
                ...
                (
                    ::std::borrow::ToOwned::to_owned("repayMorphoBlueDebt"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
                                "repayMorphoBlueDebt",
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned(
                        "MorphoBlueDebtAdaptor__HealthFactorTooLow",
                    ),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static MORPHOBLUEDEBTADAPTORV1_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct MorphoBlueDebtAdaptorV1<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for MorphoBlueDebtAdaptorV1<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for MorphoBlueDebtAdaptorV1<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for MorphoBlueDebtAdaptorV1<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for MorphoBlueDebtAdaptorV1<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(MorphoBlueDebtAdaptorV1))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> MorphoBlueDebtAdaptorV1<M> {
        ...
        ///Calls the contract's `borrowFromMorphoBlue` (0x13b70aba) function
        ...
        ///Calls the contract's `repayMorphoBlueDebt` (0x8fb75ebe) function
    ...
    ///Custom Error type `MorphoBlueDebtAdaptor__HealthFactorTooLow` with signature `MorphoBlueDebtAdaptor__HealthFactorTooLow((address,address,address,address,uint256))` and selector `0x965ab538`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(
        ...
        abi = "MorphoBlueDebtAdaptor__HealthFactorTooLow((address,address,address,address,uint256))"
    )]
    pub struct MorphoBlueDebtAdaptor__HealthFactorTooLow {
        pub market: MarketParams,
    }
    ...
    pub enum MorphoBlueDebtAdaptorV1Errors {
        BaseAdaptor__ConstructorHealthFactorTooLow(
            BaseAdaptor__ConstructorHealthFactorTooLow,
        ),
    ...
    impl ::ethers::core::abi::AbiDecode for MorphoBlueDebtAdaptorV1Errors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <MorphoBlueDebtAdaptor__HealthFactorTooLow as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MorphoBlueDebtAdaptor__HealthFactorTooLow(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for MorphoBlueDebtAdaptorV1Errors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::MorphoBlueDebtAdaptor__HealthFactorTooLow(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for MorphoBlueDebtAdaptorV1Errors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <MorphoBlueDebtAdaptor__HealthFactorTooLow as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::fmt::Display for MorphoBlueDebtAdaptorV1Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::BaseAdaptor__ConstructorHealthFactorTooLow(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for MorphoBlueDebtAdaptorV1Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BaseAdaptor__ConstructorHealthFactorTooLow>
    for MorphoBlueDebtAdaptorV1Errors {
    ...
    impl ::core::convert::From<BaseAdaptor__Slippage> for MorphoBlueDebtAdaptorV1Errors {
    ...
    impl ::core::convert::From<MorphoBlueDebtAdaptor__HealthFactorTooLow>
    for MorphoBlueDebtAdaptorV1Errors {
        fn from(value: MorphoBlueDebtAdaptor__HealthFactorTooLow) -> Self {
            Self::MorphoBlueDebtAdaptor__HealthFactorTooLow(value)
        }
    }
    ...
    ///Container type for all input parameters for the `borrowFromMorphoBlue` function with signature `borrowFromMorphoBlue((address,address,address,address,uint256),uint256)` and selector `0x13b70aba`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `repayMorphoBlueDebt` function with signature `repayMorphoBlueDebt((address,address,address,address,uint256),uint256)` and selector `0x8fb75ebe`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for MorphoBlueDebtAdaptorV1Calls {
        fn decode(
            ...
            if let Ok(decoded) = <BorrowFromMorphoBlueCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowFromMorphoBlue(decoded));
            }
            ...
            if let Ok(decoded) = <RepayMorphoBlueDebtCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RepayMorphoBlueDebt(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for MorphoBlueDebtAdaptorV1Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::BorrowFromMorphoBlue(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::RepayMorphoBlueDebt(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for MorphoBlueDebtAdaptorV1Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AccrueInterestCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: AccrueInterestCall) -> Self {
            Self::AccrueInterest(value)
        }
    }
    impl ::core::convert::From<AssetOfCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: AssetOfCall) -> Self {
            Self::AssetOf(value)
        }
    }
    impl ::core::convert::From<AssetsUsedCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: AssetsUsedCall) -> Self {
            Self::AssetsUsed(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BorrowFromMorphoBlueCall>
    for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: BorrowFromMorphoBlueCall) -> Self {
            Self::BorrowFromMorphoBlue(value)
        }
    }
    impl ::core::convert::From<DepositCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<IdentifierCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: IdentifierCall) -> Self {
            Self::Identifier(value)
        }
    }
    impl ::core::convert::From<IsDebtCall> for MorphoBlueDebtAdaptorV1Calls {
    ...
    impl ::core::convert::From<MorphoBlueCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: MorphoBlueCall) -> Self {
            Self::MorphoBlue(value)
        }
    }
    impl ::core::convert::From<RepayMorphoBlueDebtCall>
    for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: RepayMorphoBlueDebtCall) -> Self {
            Self::RepayMorphoBlueDebt(value)
        }
    }
    impl ::core::convert::From<RevokeApprovalCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: RevokeApprovalCall) -> Self {
            Self::RevokeApproval(value)
        }
    }
    impl ::core::convert::From<SlippageCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: SlippageCall) -> Self {
            Self::Slippage(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for MorphoBlueDebtAdaptorV1Calls {
        fn from(value: WithdrawCall) -> Self {
            Self::Withdraw(value)
        }
    }
    impl ::core::convert::From<WithdrawableFromCall> for MorphoBlueDebtAdaptorV1Calls {
