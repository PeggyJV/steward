...
pub mod uniswap_v3_adaptor_v2 {
    ...
    pub static UNISWAPV3ADAPTORV2_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct UniswapV3AdaptorV2<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for UniswapV3AdaptorV2<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for UniswapV3AdaptorV2<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UniswapV3AdaptorV2<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UniswapV3AdaptorV2<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UniswapV3AdaptorV2))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> UniswapV3AdaptorV2<M> {
    ...
    pub enum UniswapV3AdaptorV2Errors {
    ...
    impl ::ethers::core::abi::AbiDecode for UniswapV3AdaptorV2Errors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for UniswapV3AdaptorV2Errors {
    ...
    impl ::ethers::contract::ContractRevert for UniswapV3AdaptorV2Errors {
    ...
    impl ::core::fmt::Display for UniswapV3AdaptorV2Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::BaseAdaptor__BadSlippage(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for UniswapV3AdaptorV2Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<BaseAdaptor__BadSlippage> for UniswapV3AdaptorV2Errors {
    ...
    impl ::core::convert::From<T> for UniswapV3AdaptorV2Errors {
    ...
    impl ::core::fmt::Display for UniswapV3AdaptorV2Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddToPositionCall> for UniswapV3AdaptorV2Calls {
        fn from(value: AddToPositionCall) -> Self {
            Self::AddToPosition(value)
        }
    }
    impl ::core::convert::From<AssetOfCall> for UniswapV3AdaptorV2Calls {
        fn from(value: AssetOfCall) -> Self {
            Self::AssetOf(value)
        }
    }
    impl ::core::convert::From<AssetsUsedCall> for UniswapV3AdaptorV2Calls {
        fn from(value: AssetsUsedCall) -> Self {
            Self::AssetsUsed(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for UniswapV3AdaptorV2Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<ClosePositionCall> for UniswapV3AdaptorV2Calls {
        fn from(value: ClosePositionCall) -> Self {
            Self::ClosePosition(value)
        }
    }
    impl ::core::convert::From<CollectFeesCall> for UniswapV3AdaptorV2Calls {
        fn from(value: CollectFeesCall) -> Self {
            Self::CollectFees(value)
        }
    }
    impl ::core::convert::From<DepositCall> for UniswapV3AdaptorV2Calls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<IdentifierCall> for UniswapV3AdaptorV2Calls {
        fn from(value: IdentifierCall) -> Self {
            Self::Identifier(value)
        }
    }
    impl ::core::convert::From<IsDebtCall> for UniswapV3AdaptorV2Calls {
        fn from(value: IsDebtCall) -> Self {
            Self::IsDebt(value)
        }
    }
    impl ::core::convert::From<OpenPositionCall> for UniswapV3AdaptorV2Calls {
        fn from(value: OpenPositionCall) -> Self {
            Self::OpenPosition(value)
        }
    }
    impl ::core::convert::From<OracleSwapCall> for UniswapV3AdaptorV2Calls {
        fn from(value: OracleSwapCall) -> Self {
            Self::OracleSwap(value)
        }
    }
    impl ::core::convert::From<PurgeAllZeroLiquidityPositionsCall>
    for UniswapV3AdaptorV2Calls {
        fn from(value: PurgeAllZeroLiquidityPositionsCall) -> Self {
            Self::PurgeAllZeroLiquidityPositions(value)
        }
    }
    impl ::core::convert::From<PurgeSinglePositionCall> for UniswapV3AdaptorV2Calls {
    ...
    impl ::core::convert::From<RevokeApprovalCall> for UniswapV3AdaptorV2Calls {
        fn from(value: RevokeApprovalCall) -> Self {
            Self::RevokeApproval(value)
        }
    }
    impl ::core::convert::From<SwapCall> for UniswapV3AdaptorV2Calls {
        fn from(value: SwapCall) -> Self {
            Self::Swap(value)
        }
    }
    impl ::core::convert::From<TakeFromPositionCall> for UniswapV3AdaptorV2Calls {
        fn from(value: TakeFromPositionCall) -> Self {
            Self::TakeFromPosition(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for UniswapV3AdaptorV2Calls {
        fn from(value: WithdrawCall) -> Self {
            Self::Withdraw(value)
        }
    }
    impl ::core::convert::From<WithdrawableFromCall> for UniswapV3AdaptorV2Calls {
