pub use aura_erc4626_adaptor_v1::*;
...
pub mod aura_erc4626_adaptor_v1 {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("depositToVault"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("depositToVault"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("erc4626Vault"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
                                    internal_type: ::core::option::Option::Some(
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("_auraPool"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
                                    internal_type: ::core::option::Option::Some(
                                        ::std::borrow::ToOwned::to_owned("contract IBaseRewardPool"),
                                    ),
                                },
                                ::ethers::core::abi::ethabi::Param {
                ...
                (
                    ::std::borrow::ToOwned::to_owned("withdrawFromVault"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("withdrawFromVault"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("erc4626Vault"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
            ...
            errors: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned(
                        "AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked",
                    ),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            ...
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("auraPool"),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
                                    internal_type: ::core::option::Option::Some(
                                        ::std::borrow::ToOwned::to_owned("address"),
                                    ),
                ...
                (
                    ::std::borrow::ToOwned::to_owned(
                        "ERC4626Adaptor__ERC4626PositionNotUsed",
                    ),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
    ...
    pub static AURAERC4626ADAPTORV1_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct AuraERC4626AdaptorV1<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for AuraERC4626AdaptorV1<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for AuraERC4626AdaptorV1<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for AuraERC4626AdaptorV1<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for AuraERC4626AdaptorV1<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(AuraERC4626AdaptorV1))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AuraERC4626AdaptorV1<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    AURAERC4626ADAPTORV1_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        ///Calls the contract's `depositToVault` (0xa3d11158) function
        ...
        pub fn get_rewards(
            &self,
            aura_pool: ::ethers::core::types::Address,
            claim_extras: bool,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([33, 32, 30, 147], (aura_pool, claim_extras))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `withdrawFromVault` (0x21116f4e) function
    ...
    for AuraERC4626AdaptorV1<M> {
        fn from(contract: ::ethers::contract::Contract<M>) -> Self {
            Self::new(contract.address(), contract.client())
        }
    }
    ///Custom Error type `AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked` with signature `AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(address)` and selector `0xf2e53a81`
    #[derive(
        Clone,
    ...
    #[etherror(
        ...
        abi = "AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(address)"
    )]
    pub struct AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked {
        pub aura_pool: ::ethers::core::types::Address,
    }
    ...
    ///Custom Error type `ERC4626Adaptor__ERC4626PositionNotUsed` with signature `ERC4626Adaptor__ERC4626PositionNotUsed(address)` and selector `0x3a768352`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(
        ...
        abi = "ERC4626Adaptor__ERC4626PositionNotUsed(address)"
    )]
    pub struct ERC4626Adaptor__ERC4626PositionNotUsed {
    ...
    pub enum AuraERC4626AdaptorV1Errors {
        AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(
            AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked,
        ),
        BaseAdaptor__ConstructorHealthFactorTooLow(
        ...
        ERC4626Adaptor__ERC4626PositionNotUsed(ERC4626Adaptor__ERC4626PositionNotUsed),
        /// The standard solidity revert string, with selector
        /// Error(string) -- 0x08c379a0
        RevertString(::std::string::String),
    }
    impl ::ethers::core::abi::AbiDecode for AuraERC4626AdaptorV1Errors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(
                    Self::AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(decoded),
                );
            }
            ...
            if let Ok(decoded) = <ERC4626Adaptor__ERC4626PositionNotUsed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ERC4626Adaptor__ERC4626PositionNotUsed(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for AuraERC4626AdaptorV1Errors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                Self::AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(element) => {
                ...
                Self::ERC4626Adaptor__ERC4626PositionNotUsed(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for AuraERC4626AdaptorV1Errors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                [0x08, 0xc3, 0x79, 0xa0] => true,
                _ if selector
                    == <AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                ...
                _ if selector
                    == <ERC4626Adaptor__ERC4626PositionNotUsed as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::fmt::Display for AuraERC4626AdaptorV1Errors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for AuraERC4626AdaptorV1Errors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked>
    for AuraERC4626AdaptorV1Errors {
        fn from(value: AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked) -> Self {
            Self::AuraExtrasAdaptor__AuraPoolPositionsMustBeTracked(value)
        }
    }
    ...
    impl ::core::convert::From<BaseAdaptor__Slippage> for AuraERC4626AdaptorV1Errors {
    ...
    impl ::core::convert::From<ERC4626Adaptor__ERC4626PositionNotUsed>
    for AuraERC4626AdaptorV1Errors {
        fn from(value: ERC4626Adaptor__ERC4626PositionNotUsed) -> Self {
            Self::ERC4626Adaptor__ERC4626PositionNotUsed(value)
        }
    }
    ...
    ///Container type for all input parameters for the `depositToVault` function with signature `depositToVault(address,uint256)` and selector `0xa3d11158`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `withdrawFromVault` function with signature `withdrawFromVault(address,uint256)` and selector `0x21116f4e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    pub enum AuraERC4626AdaptorV1Calls {
        AssetOf(AssetOfCall),
    ...
    impl ::ethers::core::abi::AbiDecode for AuraERC4626AdaptorV1Calls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded) = <DepositToVaultCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::DepositToVault(decoded));
            }
            ...
            if let Ok(decoded) = <WithdrawFromVaultCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::WithdrawFromVault(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for AuraERC4626AdaptorV1Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::WithdrawFromVault(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::fmt::Display for AuraERC4626AdaptorV1Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::DepositToVault(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::WithdrawFromVault(element) => ::core::fmt::Display::fmt(element, f),
                Self::WithdrawableFrom(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<AssetOfCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: AssetOfCall) -> Self {
            Self::AssetOf(value)
        }
    }
    impl ::core::convert::From<AssetsUsedCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: AssetsUsedCall) -> Self {
            Self::AssetsUsed(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<DepositCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<DepositToVaultCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: DepositToVaultCall) -> Self {
            Self::DepositToVault(value)
        }
    }
    impl ::core::convert::From<GetRewardsCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: GetRewardsCall) -> Self {
            Self::GetRewards(value)
        }
    }
    impl ::core::convert::From<IdentifierCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: IdentifierCall) -> Self {
            Self::Identifier(value)
        }
    }
    impl ::core::convert::From<IsDebtCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: IsDebtCall) -> Self {
            Self::IsDebt(value)
        }
    }
    impl ::core::convert::From<RevokeApprovalCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: RevokeApprovalCall) -> Self {
            Self::RevokeApproval(value)
        }
    }
    impl ::core::convert::From<SlippageCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: SlippageCall) -> Self {
            Self::Slippage(value)
        }
    }
    impl ::core::convert::From<WithdrawCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: WithdrawCall) -> Self {
            Self::Withdraw(value)
        }
    }
    impl ::core::convert::From<WithdrawFromVaultCall> for AuraERC4626AdaptorV1Calls {
        fn from(value: WithdrawFromVaultCall) -> Self {
            Self::WithdrawFromVault(value)
        }
    }
    impl ::core::convert::From<WithdrawableFromCall> for AuraERC4626AdaptorV1Calls {
